...
module.exports = function(sequelize, DataTypes) {
  return sequelize.define('wfhuserprofile', {
    wfhuser_id: {
      autoIncrement: true,
    ...
    wfhuser_email_address: {
      type: DataTypes.STRING(50),
      allowNull: false,
      comment: "the email address of the user",
      unique: "applicant_email_address"
    },
    wfhuser_fbemail: {
      type: DataTypes.TEXT,
      allowNull: true
    ...
    applicant_previous1_addr_county: {
      type: DataTypes.STRING(20),
      allowNull: true
    },
    ...
    applicant_previous1_moveindate: {
      type: DataTypes.STRING(20),
      allowNull: true
    },
    ...
    applicant_employer1_work_dateofhire: {
      type: DataTypes.STRING(20),
      allowNull: true
    },
    ...
    indexes: [
      ...
      },
      {
        ...
        using: "BTREE",
        fields: [
          { name: "wfhuser_email_address" },
        ]
      },
      {
        name: "wfhuser_username",
        unique: true,
        using: "BTREE",
        fields: [
          { name: "wfhuser_username" },
      ...
      },
      {
        ...
        using: "BTREE",
        fields: [
          { name: "wfhuser_tokenid", length: 333 },
        ]
      },
      {
