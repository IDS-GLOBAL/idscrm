...
$GLOBALS['ct_recipient']   = 'idscrm.com@gmail.com'; // Change to your email address!
...
<head>
  ...
  <title>IDSCRM Securimage Captcha Example Form</title>
  <style type="text/css">
  <!--
...
<form action="<?php echo htmlspecialchars($_SERVER['REQUEST_URI'] . $_SERVER['QUERY_STRING']) ?>" method="post" target="_blank" id="contact_form">
