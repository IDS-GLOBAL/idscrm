...
<nav class="navbar navbar-static-top white-bg" role="navigation" style="margin-bottom: 0">
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li>
					...
					<input id="dtimezone" type="hidden"  value="<?php echo $zone_to; ?>"/>
                    <input id="page_refer" type="hidden" value="<?php echo $onpage_current; ?>" />
                    
                </li>
                <li>
                    <a class="count-info" href="inventory.php" title="<?php echo $vstat_text; ?> Inventory">
                ...
                <!-- Credit Applications -->
                <li class="dropdown">
                    <a class="dropdown-toggle count-info" data-toggle="dropdown" href="credit-apps.php" title="Credit Apps">
                        <i class="fa fa-database"></i>  <span class="label label-warning"><?php echo $totalRows_find_dealerapps; ?></span>
                    </a>
                ...
                <!-- Unread Leads -->
                <li class="dropdown">
                    <a class="dropdown-toggle count-info" data-toggle="dropdown" href="leads.php" title="Leads">
