...
<nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        ...
                        <div class="dropdown profile-element"> <span>
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                <li><a href="manager.account.php">My Account</a></li>
                                <li><a href="manager.invoices.php">Billing</a></li>
                                <li><a href="http://webmail.idscrm.com/" target="_blank">Mailbox</a></li>
                                <li><a href="manager.account.php">Settings</a></li>
                                <li class="divider"></li>
                    ...
                    <!-- li class="active" -->
                    <li class="active">
                        <a href="manager.php"><i class="fa fa-th-large"></i> <span class="nav-label">Dashboard</span></a>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li class="active">
                                <a href="manager.appointments.php">View Appointments</a>
                            </li>
                            <!--li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a href="manager.customers.php">Customers</a></li>
                            <li><a href="manager.leads.php">Leads</a></li>
                            <li><a href="manager.facebookusers.php">Facebook Users</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a href="manager.credit-apps.php">Credit Applications</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="manager.tasknew.php">New Task</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a href="manager.inventory.php?vstat=1">Live Inventory</a></li>
                            <li><a href="manager.inventory.php?vstat=0">View Hold Inventory</a></li>
                            <li><a href="manager.inventory.php?vstat=9">View Sold Inventory</a></li>
                            <li><a href="manager.inventory.php?vstat=all" title="Everything">View All Inventory</a></li>
                            <li><a href="manager.inventory.add.php">Add Inventory</a></li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a href="manager.salesdesk.php">Sales Desk</a></li>
							<li><a href="manager.dealmatrix.php">Sales Desk Settings</a></li>
                            <li><a href="manager.deals.php">View Deals</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-envelope"></i> <span class="nav-label">Email Templates </span><span class="label label-warning pull-right">3/10</span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="manager.emailtemplates.php">View Templates</a></li>
                            <li><a href="manager.emailtemplate.add.php">Create Email Template</a></li>
                            <li><a href="manager.emailtemplatessent.php">Emails Sent</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a href="manager.departments.php">View Departments</a></li>
                            <li><a href="manager.department.add.php">Create A New Department</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="manager.salespeople.php">Sales People</a>
                            </li>
                            <li>
                                <a href="manager.managers.php">Managers</a>
                            </li>
                            <li>
                                <a href="manager.collectors.php">Collectors</a>
                            </li>
                    ...
                    <li class="special_link">
                        ...
                        <ul class="nav nav-second-level">
                            <li><a href="manager.website.home.php">Home</a></li>
                            <li><a href="manager.website.aboutus.php">About Us</a></li>
                            <li><a href="manager.website.directions.php">Directions</a></li>
                            <li><a href="manager.website.contactus.php">Contact Us</a></li>
                            <li><a href="manager.website.storeinfo.php">Store Info</a></li>
                            <li><a href="manager.website.testimonies.php">Testimonies</a></li>
                            <li><a href="manager.website.thankyou.php">Thank You Page</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="special_link">
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li><a href="manager.ticket.history.php">View Trouble Ticket(s)</a></li>
                            <li><a href="manager.ticket.create.php">Create A Trouble Ticket</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="special_link">
                        <a href="manager.dealmatrix.php"><i class="fa fa-magic"></i> <span class="nav-label">Deal Matrix</span> 
                    ...
                    <li class="special_link">
                        ...
                        <ul class="nav nav-second-level">
                            <li><a href="manager.invoices.php">Invoices</a></li>
