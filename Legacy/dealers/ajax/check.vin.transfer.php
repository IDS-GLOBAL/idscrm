...
$checkvin_sql = "SELECT `vehicles`.`vid`, `vehicles`.`did`, `vehicles`.`vvin` FROM `idsids_idsdms`.`vehicles` WHERE `vehicles`.`vvin`= '$vvin'";
$checkvin = mysqli_query($idsconnection_mysqli, $checkvin_sql);
