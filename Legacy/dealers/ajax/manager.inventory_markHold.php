...
$markTheseVehicles = mysql_real_escape_string($_POST['markTheseVehicles']);
...
if (isset($_POST['markTheseVehicles']) ){
	...
	$UPDATE_VEHICLE_SQL = "UPDATE `idsids_idsdms`.`vehicles` SET `vlivestatus` = '0' WHERE `vehicles`.`vid` = '$thisvid'";
...
mysqli_select_db($idsconnection_mysqli, $database_idsconnection);
$query_LiveVehicles = "SELECT * FROM vehicles WHERE vehicles.did = $did AND vehicles.vlivestatus = '0' ORDER BY vehicles.created_at DESC ";
