...
$query_find_vinyear = "SELECT * FROM `idsids_idsdms`.`vvin_ten` WHERE `vvin_ten`.`vinten_year` BETWEEN $vinyear_range AND `vvin_ten`.`vinten_code` = '$j' ORDER BY `vvin_ten`.`vinten_id` DESC";
