...
mysqli_select_db($idsconnection_mysqli, $database_idsconnection);
$query_quick_appointment =  "SELECT * FROM `idsids_idsdms`.`dealers_appointments` WHERE `dlr_appt_token` = '$colname_quick_appointment'";
$quick_appointment = mysqli_query($idsconnection_mysqli, $query_quick_appointment);
$row_quick_appointment = mysqli_fetch_array($quick_appointment);
