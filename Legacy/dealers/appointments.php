...
$query_find_customers = "SELECT * FROM  `idsids_idsdms`.`customers` WHERE `customers`.`customer_dealer_id` = '$did' ORDER BY `customers`.`customer_id` ASC";
...
$concat_unique = array('2020', '15', '17', 'vin17', 'tag1', 'stock#', 'last4', 'auction2');
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-8">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="appointments.timeline.php">Appointments</a>
                    </li>
                    <li class="active">
        ...
        $(document).ready(function() {
            ...
            $('#calendar').fullCalendar({
				...
				eventClick: function(calEvent, jsEvent, view) {
					...
					var calEvent = calEvent.url;
					var calEventID = calEvent.id;
					console.log('calEventID: ' + calEventID);
					...
					{events:[
						{
							id: 993,
							title: 'End Of Month',
							start:  new Date(newdate.getFullYear(), newdate.getMonth() + 1, 0),
						...
						},
						{
							id: 993,
							title: 'End Of Year',
							start: new Date(2019, 11, 31, 00, 01),
							end: new Date(2019, 11, 31, 23, 59),
							allDay: true,
							color: '#17F06C',
							className: 'idsRobot',
							url: ''
