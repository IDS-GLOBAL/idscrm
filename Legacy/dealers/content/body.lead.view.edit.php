...
<div class="">
                                ...
                                <div class="form-group">
									<label class="col-sm-12 control-label" for="">Lead Assignment <a style="float:right !important; font-size:10px;" href="salesperson.add.php" target="_blank" >Missing Staff ???</a></label>
									
                                    <div class="col-sm-12">
                                        <div class="row">
                                            <div class="col-md-6">
											<label class="col-sm-9 control-label">Sales Person 1</label>
  ...
  if($rows > 0) {
	  ...
	  $row_true_salesperson = mysqli_fetch_assoc($true_salesperson);
                                            ...
                                            <div class="col-md-6">
											<label class="col-sm-9 control-label">Sales Person 2</label>
  ...
  if($rows > 0) {
	  ...
	  $row_true_salesperson = mysqli_fetch_assoc($true_salesperson);
                                            ...
                                            <div class="col-md-6">
											<label class="col-sm-9 control-label">BDC</label>
              ...
              <?php if($totalRows_true_salesperson != 0):     do {  ?>
              <option value="<?php echo $row_true_salesperson['cust_bdc_id']; ?>"<?php if (!(strcmp($row_true_salesperson['cust_bdc_id'], $row_view_thislead['cust_bdc_id']))) {echo "selected=\"selected\"";} ?>><?php echo $row_true_salesperson['salesperson_firstname']?> <?php echo $row_true_salesperson['salesperson_lastname']?></option>
              <?php
} while ($row_true_salesperson = mysqli_fetch_assoc($true_salesperson));
  $rows = mysqli_num_rows($true_salesperson);
  if($rows > 0) {
	  ...
	  $row_true_salesperson = mysqli_fetch_assoc($true_salesperson);
                                            ...
                                            <div class="col-md-6">
											<label class="col-sm-9 control-label">Manager</label>
...
<select class="form-control m-b" name="cust_titlename" id="cust_titlename">
    ...
    <div class="form-group"><label class="col-sm-2 control-label">Suffix</label> 
    	...
    	<input id="cust_name_suffix" type="text" placeholder="Suffix" class="form-control" value="<?php echo $row_view_thislead['cust_name_suffix']; ?>">
                            ...
                            <div class="col-sm-6"><h4>Stat Information</h4>
...
<div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-offset-2 col-lg-10">
                                        <div class="timeago"><?php if(!$row_view_thislead['cust_lead_created_at']){}else{ echo '<strong>Created On: </strong>' . date("M d, Y - h:i a / D", strtotime($row_view_thislead['cust_lead_created_at'])); } ?></div>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
...
?>
                                ...
                                <div class="hr-line-dashed"></div>
                                 ...
                                 <div class="form-group"><label  class="col-sm-2 control-label">Other Income Source</label>
                                 	<div class="col-sm-10">
                                    <input id="cust_other_income" class="form-control" type="text" value="<?php echo $row_view_thislead['cust_other_income']; ?>" placeholder="Other Income Source">
                                ...
                                <div class="hr-line-dashed"></div>
                                 ...
                                 <div class="form-group"><label  class="col-sm-2 control-label">Other Income Amount</label>
                                 	<div class="col-sm-10">
                                    <input id="cust_other_income_amount" class="form-control"  type="number" placeholder="Other Income Amount" value="<?php echo $row_view_thislead['cust_other_income_amount']; ?>">
