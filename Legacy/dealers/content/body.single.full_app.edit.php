                    ...
                    <div class="form-group">
                      ...
                      <label class="col-sm-3 control-label">Landlord/Mortgage Address:</label>
                        <div class="col-sm-9">
                            ...
                            <input type="text" class="form-control" id="applicant_addr_landlord_address" placeholder="Mortgage or Mortgage Address" value="<?php echo $row_find_dlr_creditapp['applicant_addr_landlord_address']; ?>">
                        </div>
                    </div>
                                ...
                                <div class="hr-line-dashed"></div>
												...
												<div class="col-sm-9">
													...
													<select class="form-control" id="applicant_addr_years">
														<option value="0 Year" <?php if (0 == $row_find_dlr_creditapp['applicant_addr_years']){ echo "selected=\"selected\"";} ?>>0 Years</option>
														<option value="1 Years" <?php if (1 == $row_find_dlr_creditapp['applicant_addr_years']){ echo "selected=\"selected\"";} ?>>1 Years</option>
														<option value="2 Years" <?php if (2 == $row_find_dlr_creditapp['applicant_addr_years']){ echo "selected=\"selected\"";} ?>>2 Years</option>
														<option value="3 Years" <?php if (3 == $row_find_dlr_creditapp['applicant_addr_years']){ echo "selected=\"selected\"";} ?>>3 Years</option>
														<option value="4 Years" <?php if (4 == $row_find_dlr_creditapp['applicant_addr_years']){ echo "selected=\"selected\"";} ?>>4 Years</option>
														<option value="5 Years" <?php if (5 == $row_find_dlr_creditapp['applicant_addr_years']){ echo "selected=\"selected\"";} ?>>5 Years</option>
														<option value="6 Years" <?php if (6 == $row_find_dlr_creditapp['applicant_addr_years']){ echo "selected=\"selected\"";} ?>>6 Years</option>
														<option value="7 Years" <?php if (7 == $row_find_dlr_creditapp['applicant_addr_years']){ echo "selected=\"selected\"";} ?>>7 Years</option>
														<option value="8 Years" <?php if (8 == $row_find_dlr_creditapp['applicant_addr_years']){ echo "selected=\"selected\"";} ?>>8 Years</option>
														<option value="9 Years" <?php if (9 == $row_find_dlr_creditapp['applicant_addr_years']){ echo "selected=\"selected\"";} ?>>9 Years</option>
														<option value="10 Years" <?php if (10 == $row_find_dlr_creditapp['applicant_addr_years']){ echo "selected=\"selected\"";} ?>>10 Years</option>
                                                    </select>
												</div>
												</div>
...
do {  
?>
                                          <option value="<?php echo $row_carYears ['year']?>"<?php if (!(strcmp($row_carYears ['year'], $row_find_dlr_creditapp['applilcant_v_trade_year']))) {echo "selected=\"selected\"";} ?>><?php echo $row_carYears ['year']?></option>
                                          <?php
