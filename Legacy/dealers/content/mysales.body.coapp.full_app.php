<?php include("../ajax/mysales.db.php"); ?>
<?php
...
<input type='hidden' id='joint_creditapp_joint_creditapp_Applicant_key' value='<?php echo $applicant_app_token; ?>' />
                        ...
                        <div class="ibox-content">
                            ...
                            <div id="personal_info_block" class="form-horizontal m-t-md">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input id="aapplicant_fname" type="text" class="form-control" placeholder="First Name" value="">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input id="aapplicant_mname" type="text" class="form-control" placeholder="Middle Name" value="">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input id="aapplicant_lname" type="text" class="form-control" placeholder="Last Name" value="">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input id="aapplicant_name" type="text" class="form-control" placeholder="Perferred Name" value="">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input id="aapplicant_cell_phone" type="text" class="form-control" data-mask="(999) 999-9999" placeholder="(123) 456-7890">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input id="aapplicant_email_address" type="text" class="form-control" placeholder="">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input id="aapplicant_driver_licenses_number" type="text" class="form-control" placeholder="">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input id="aapplicant_ssn" data-mask="999-99-9999" type="text" class="form-control" placeholder="">
    ...
    DOB(MM/DD/YYYY):                                
                                    <div class="input-group date">
                                        ...
                                        <input id="aapplicant_dob"  data-mask="99/99/9999" type="text" class="form-control" value="">
                                    </div>
                               ...
                               <div class="hr-line-dashed"></div>
                                ...
                                <div class="form-group" id="data_4">
                                    ...
                                    <div class="input-group date">
                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input id="aapplicant_driver_licenses_expdate"  data-mask="99/99/9999" type="text" class="form-control" placeholder="07/01/2016" value="">
                                    </div>
                                </div>
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="form-horizontal m-t-md">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="aapplicant_present_address1" placeholder="Street Address">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
					...
					<div class="col-sm-9">
                        <input type="text" class="form-control" id="aapplicant_present_address2" placeholder="Apt. Bldg, Unit">
                        <span class="help-block"></span>
                    </div>
					...
					<div class="col-sm-9">
                        <input type="text" class="form-control" id="aapplicant_present_addr_city" placeholder="City">
                    </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <label class="col-sm-3 control-label">County:</label>
                        <div class="col-sm-9">
                            ...
                            <input type="text" class="form-control" id="aapplicant_present_addr_county" placeholder="County">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <label class="col-sm-3 control-label">Zip:</label>
                        <div class="col-sm-9">
                            ...
                            <input type="text" class="form-control" id="aapplicant_present_addr_zip" placeholder="Zip">
                        </div>
                    </div>
                   ...
                   <div class="form-group">
                      ...
                      <label class="col-sm-3 control-label">Landlord/Mortgage Co:</label>
                        <div class="col-sm-9">
                            ...
                            <input type="text" class="form-control" id="aapplicant_addr_landlord_mortg" placeholder="Mortgage or Landlord Name" value="">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <label class="col-sm-3 control-label">Landlord/Mortgage Address:</label>
                        <div class="col-sm-9">
                            ...
                            <input type="text" class="form-control" id="aapplicant_addr_landlord_address" placeholder="Mortgage or Landlord Address" value="">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <label class="col-sm-3 control-label">Landlord/Mortgage City:</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="aapplicant_addr_landlord_city" placeholder="Mortgage or Landlord City">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <label class="col-sm-3 control-label">Landlord/Mortgage Zip:</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="aapplicant_addr_landlord_zip" placeholder="Mortgage or Landlord Zip Code">
                        </div>
                    </div>
                    <div class="form-group">
                        <!-- form input -->
                      <label class="col-sm-3 control-label">Landlord/Mortgage Phone:</label>
                        <div class="col-sm-9">
                            <input data-mask="(999) 999-9999" type="text" class="form-control" id="aapplicant_addr_landlord_phone" placeholder="Mortgage or Landlord Phone">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <label class="col-sm-3 control-label">Who's Name On Current Lease:</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="aapplicant_name_oncurrent_lease" placeholder="Name On Current Lease/Mortgage">
                        </div>
                    </div>
					...
					<div class="col-sm-9">
													...
													<input type="text" class="form-control" id="aapplicant_house_payment" placeholder="Mortage Payment">
												</div>
                                                </div>
                                <div class="hr-line-dashed"></div>
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="form-horizontal m-t-md">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="aapplicant_previous1_addr1" placeholder="Previous Street Address">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
					...
					<div class="col-sm-9">
                        <input type="text" class="form-control" id="aapplicant_previous1_addr2" placeholder="Apt. Bldg, Unit">
                        <span class="help-block"></span>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <label class="col-sm-3 control-label">City:</label>
					<div class="col-sm-9">
                        <input type="text" class="form-control" id="aapplicant_previous1_addr_city" placeholder="City">
                    </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <label class="col-sm-3 control-label">Zip:</label>
                        <div class="col-sm-9">
                            ...
                            <input type="text" class="form-control" id="aapplicant_previous1_addr_zip" placeholder="Zip">
                        </div>
                    </div>
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                              ...
                              <div class="col-sm-9">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                        <input id="aapplicant_employer1_position" type="text" class="form-control" value="" placeholder="Job Title/Position"  />
                                        </div>
									</div>
									...
									<div class="form-group">	
                                      ...
                                      <div class="col-sm-9">
                                        <input id="aapplicant_employer1_name" type="text" class="form-control" value="" placeholder="Employer Name"  />
                                        </div>
									</div>
									...
									<div class="form-group">
                                      ...
                                      <div class="col-sm-9">
                                        <input data-mask="(999) 999-9999" id="aapplicant_employer1_phone" type="text" class="form-control" value="" placeholder="Previous Employer Phone"  />
                                      </div>
									</div>
									...
									<div class="form-group">
                                      ...
                                      <div class="col-sm-9">
                                        <input id="aapplicant_employer1_addr" type="text" class="form-control" value="" placeholder="Employer Address"  />
                                      </div>
									</div>
									...
									<div class="form-group">
                                      ...
                                      <div class="col-sm-9">
                                      <input id="aapplicant_employer1_city" type="text" class="form-control" value="" placeholder="Employer City"  />
                                      </div>
                                    </div>
									...
									<div class="form-group">
                                      ...
                                      <div class="col-sm-9">
                                      <input id="aapplicant_employer1_zip" type="text" class="form-control" value=""  placeholder="Employer Zip Code" />
                                      </div>
                                      ...
                                      <div class="col-sm-9">
                                      <input id="aapplicant_employer1_salary_bringhome" type="text" class="form-control" value=""  placeholder="Gross Monthly Income" />
                                      </div>
									</div>
                            ...
                            <label class="col-sm-3 contorl-label">Any Employer Work Comments:</label>
                                <div class="col-sm-9">
                          <textarea id="auser_applicant_employer_notes" class="form-control textarea" placeholder="Employer Comments"></textarea>
                                </div>
                            </div>
                           ...
                           <div class="hr-line-dashed"></div>
                                      ...
                                      <div class="col-sm-9">
                                      <input id="aapplicant_other_income_amount" type="text" class="form-control" value=""  placeholder="Other Income Amount" />
                                      </div>
									</div>
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="form-horizontal m-t-md">
									...
									<div class="form-group">
                                        ...
                                        <input id="aapplicant_employer2_position" type="text" class="form-control" value="" placeholder="Previous Job Title" />
                                    	</div>
                                    </div>
									...
									<div class="form-group">	
                                      ...
                                      <div class="col-sm-9">
                                        <input id="aapplicant_employer2_name" type="text" class="form-control" value="" placeholder="Employer Name"  />
                                        </div>
									</div>
									...
									<div class="form-group">
                                      ...
                                      <div class="col-sm-9">
                                        <input id="aapplicant_employer2_phone" data-mask="(999) 999-9999" type="text" class="form-control" value="" placeholder="Phone"  />
                                      </div>
									</div>
									...
									<div class="form-group">
                                   	  ...
                                   	  <label class="col-sm-3 control-label">Employer Street Address</label>
                                      <div class="col-sm-9">
                                        <input id="aapplicant_employer2_addr" type="text" class="form-control" value="" placeholder="Phone"  />
                                      </div>
									</div>
									...
									<div class="form-group">
                                   	  <label class="col-sm-3 control-label">City</label>
                                      <div class="col-sm-9">
                                      <input id="aapplicant_employer2_city" type="text" class="form-control" value="" placeholder="Phone"  />
                                      </div>
                                    </div>
									...
									<div class="form-group">
                                   	  <label class="col-sm-3 control-label">Zip</label>
                                      <div class="col-sm-9">
                                      <input id="aapplicant_employer2_zip" type="text" class="form-control" value=""  placeholder="Zip Code" />
                                      </div>
  									...
  									<div class="form-group">
                                   	  <label class="col-sm-3 control-label">Gross Monthly Income</label>
                                      <div class="col-sm-9">
                                      <input id="aapplicant_employer2_salary_bringhome" type="text" class="form-control" value=""  placeholder="Monthly Income" />
                                      </div>
									</div>
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="form-horizontal m-t-md">
                                        ...
                                        <div class="col-sm-9">
                                        <input type="text" class="form-control" id="aapplicants_realative1_fname" value="" placeholder="First Name Of Nearest Realative">
                                        </div>
                                        </div>
                                        ...
                                        <div class="col-sm-9">
                                        <input type="text" class="form-control" id="aapplicants_realative1_lname" value="" placeholder="Last Name Of Nearest Realative">
                                        </div>
                                        </div>
                                        ...
                                        <div class="col-sm-9">
                                        <input type="text" class="form-control" id="aapplicants_realative1_relationship" value="" placeholder="Relationship Of Nearest Realative">
                                        </div>
                                        </div>
                                        ...
                                        <div class="col-sm-9">
                                        <input type="text" class="form-control" id="aapplicants_realative1_mainphone" value="" placeholder="Phone No. Of Nearest Realative">
                                        </div>
                                        </div>
                                        ...
                                        <div class="col-sm-9">
                                        <input type="text" class="form-control" id="aapplicants_realative1_address" value="" placeholder="Address Of Nearest Realative">
                                        </div>
                                        </div>
                                        ...
                                        <div class="col-sm-9">
                                        <input type="text" class="form-control" id="aapplicants_realative1_address_city" value="" placeholder="City Of Nearest Realative">
                                        </div>
                                        </div>
                                        ...
                                        <div class="col-sm-9">
                                        <input type="text" class="form-control" id="aapplicants_realative1_address_zip" value="" placeholder="Zip Of Nearest Relative">
                                        </div>
                                        </div>
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="form-horizontal m-t-md">
                                ...
                                <div class="hr-line-dashed"></div>
									...
									<div class="resume-details br-lblue animatedd">
                                        ...
                                        <div class="col-sm-9">
                                        <textarea class="form-control" id="aapplilcant_v_intendeduse" rows="3" placeholder="Comments"></textarea>
                                        </div>
                                        </div>
							...
							<div id="vehicleFoundResult">
                             <input type="hidden" id="cust_vehicle_id" name="cust_vehicle_id" value="">
                                        ...
                                        <div class="col-sm-9">
                                        <input type="text" class="form-control" id="aapplilcant_v_stockno" value="" placeholder="Stock Number" />
                                        </div>
                                        </div>
                                        ...
                                        <div class="col-sm-9">
                                        <input type="text" class="form-control" id="aapplilcant_v_vin" value="" placeholder="VIN"  />
                                        </div>
                                        </div>
										...
										<div class="col-sm-9">
										<input type="text" class="form-control" id="aapplilcant_v_ymkmd_txt" value="" placeholder="Year Make &amp; Model" />
                                        </div>
                                        </div>
                                        ...
                                        <div class="col-sm-9">
                                        <input type="text" class="form-control" id="aapplilcant_v_style" value="" placeholder="Body Style"  />
                                        </div>
                                        </div>
                                        ...
                                        <div class="col-sm-9">
                                        <input type="text" class="form-control" id="aapplilcant_v_inception_miles" value="" placeholder="Miles"  />
                                        </div>
                                        </div>
                                        ...
                                        <div class="col-sm-9">
                                        <input type="text" class="form-control" id="aapplilcant_v_cash_down" value="" placeholder="$"  />
                                        </div>
                                        </div>
                                        ...
                                        <div class="col-sm-9">
                                        <input type="text" class="form-control" id="aapplicant_desired_mo_payment" value="" placeholder="$"  />
                                        </div>
                                        </div>
...
?>
                                        ...
                                        <div class="col-sm-9">
                                        <input class="form-control" id="aapplilcant_v_trade_make" value="">
                                        </div>
                                        </div>
                                        ...
                                        <div class="col-sm-9">
                                        <input class="form-control" id="aapplilcant_v_trade_model" value="">
                                        ...
                                        <input type="text" id="aapplilcant_v_trade_lien_holder_name" class="form-control" placeholder="Name Of Finance Company?">
										</div>
                                        </div>
                                        ...
                                        <div class="col-sm-9">
                                        <input type="text" class="form-control" id="aapplicant_open_autoloan_pymt" value="" placeholder="Current Car Payment?"  />
                                        </div>
                                        </div>
                                    ...
                                    <div id="yesTradeVehicle_block" style="display:block;">
                                        ...
                                        <div class="col-sm-9">
                                        <input type="text" class="form-control" id="aapplilcant_v_trade_owed" value="" placeholder="Balance On Current Vehicle"  />
                                        </div>
                                        </div>
                                        ...
                                        <div class="col-sm-9">
									<input class="form-control" type="text" id="auser_comments_trade_notes" placeholder="Reason For Trade?">
										</div>
                                        </div>
