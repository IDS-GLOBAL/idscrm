...
$query_find_dlr_creditapp = "SELECT * FROM `idsids_idsdms`.`credit_app_fullblown` WHERE `credit_app_fullblown`.`credit_app_fullblown_id` = '$colname_find_dlr_creditapp'";
			...
			<div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-sm-12">
                    <div class="title-action">
                        ...
                        <a href="creditapp.add.php" class="btn btn-primary btn-sm m-b">Create A New Credit Application</a>
                    </div>
                </div>
...
<div class="col-lg-12">
                ...
                <button class="btn btn-warning dim btn-large-dim" onClick="window.open('autoloanCreditApp-pdf.php?credit_app_id=<?php echo $credit_app_fullblown_id; ?>&keytoken=<?php echo $row_find_dlr_creditapp['applicant_app_token']; ?>');" type="button"><i class="fa fa-print"></i></button>
                        ...
                        <div class="ibox-content">
                            ...
                            <div id="personal_info_block" class="form-horizontal m-t-md">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input rel="nick_name" type="text" class="form-control" placeholder="Perferred Name" id="<?php echo $row_find_dlr_creditapp['applicant_name']; ?>">
