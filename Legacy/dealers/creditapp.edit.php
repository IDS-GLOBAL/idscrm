...
if(!$credit_app_id){ header("Location: credit-apps.php"); }
                    ...
                    <div class="panel blank-panel">
                        ...
                        <div class="panel-heading">
                            ...
                            <h4>
							 ...
							 Update Auto Loan Credit Application
                            </h4>
                            </div>
                ...
                <div class="col-sm-6">
					...
					<div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            <p>Here you can pull one of your exisiting credit applicantions and join to this application.</p>
                             <button id="selling_vehicle_btn" class="btn btn-default" type="button">Selling Vehicle</button>
					...
					<div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            <p>Here you can pull one of your exisiting vehicles into this credit application.</p>
                             ...
                             <div id="trade_vehicle_pane" style="display:block;">


								<div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label">Year</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" data-mask="9999" placeholder="Year">
                                        <span class="help-block">i.e. year</span>
                                    </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <span class="help-block">i.e. manufacturer</span>
                                    </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <span class="help-block">i.e. model</span>
                                    </div>
