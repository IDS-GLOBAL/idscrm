            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a href="search_results.html">WeFinanceHere.com</a><span class="pull-right label label-primary">SPECIAL</span></li>
                            <li><a href="lockscreen.html">AutoCityMag.com</a></li>
                        </ul>
                    </li>
