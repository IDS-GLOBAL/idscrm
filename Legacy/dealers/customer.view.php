...
mysqli_select_db($idsconnection_mysqli, $database_idsconnection);
$query_dealer_etemplates = "SELECT * FROM `idsids_idsdms`.`email_dealer_templates` WHERE `email_dealer_templates_did` = '$did' ORDER BY `email_dealer_templates_subject` ASC";
...
<body>
        ...
        <?php include("_nav_top.php"); ?>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        <li>
                            <a href="dashboard.php" target="_parent">Dashboard</a>
                        </li>
                        <li>
	...
	<div class="row">
			<div class="col-lg-12">
                ...
                <a class="btn btn-info  dim btn-large-dim btn-outline" target="_parent" href="customer.edit.php?customer_id=<?php echo $row_view_thiscustomer['customer_id']; ?>"><i class="fa fa-pencil-square-o fa-3x"></i></a>
