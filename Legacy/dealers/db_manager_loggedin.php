...
$query_userDets =  "SELECT * FROM `idsids_idsdms`.`dealers`, `manager_person` WHERE `dealers`.`id` = `manager_person`.`dealer_id` AND `manager_person`.`manager_email` =  '$colname_userDets'";
...
mysqli_select_db($idsconnection_mysqli, $database_idsconnection);
$query_dlrSlctBySsnDid =  "SELECT * FROM `idsids_idsdms`.`dealers` WHERE `dealers`.`id` = '$did'";
...
mysqli_select_db($idsconnection_mysqli, $database_idsconnection);
$query_find_vehicle_photos =  "SELECT * FROM `idsids_idsdms`.`vehicle_photos` WHERE `vehicle_photos`.`vehicle_id` = '$colname_find_vehicle_photos' ORDER BY `sort_orderno` ASC";
...
$query_vehiclesOnHld = "SELECT `vehicles`.`vlivestatus`, `vehicles`.`vid`,
    (SELECT COUNT(*) FROM `idsids_idsdms`.`vehicles` WHERE `vlivestatus` = '0' AND `did` = '$did') as HOLD,
    (SELECT COUNT(*) FROM `idsids_idsdms`.`vehicles` WHERE `vlivestatus` = '1' AND `did` = '$did') as LIVE,
    (SELECT COUNT(*) FROM `idsids_idsdms`.`vehicles` WHERE `vlivestatus` = '3' AND `did` = '$did') as AUCTION,
    (SELECT COUNT(*) FROM `vehicles` WHERE `vlivestatus` = '9' AND `did` = '$did') as SOLD
FROM `vehicles`  GROUP BY `vid`";
...
mysqli_select_db($idsconnection_mysqli, $database_idsconnection);
$query_customer_leads = "SELECT * FROM `idsids_idsdms`.`cust_leads` WHERE `cust_leads`.`cust_dealer_id` = '$did' ORDER BY `cust_leads`.`cust_leadid` DESC";
...
mysqli_select_db($idsconnection_mysqli, $database_idsconnection);
$query_find_unreadleads = "SELECT * FROM `idsids_idsdms`.`cust_leads` WHERE `cust_leads`.`cust_dealer_id` = '$did' AND `cust_leads`.`cust_seenbydlr` = '0' ORDER BY `cust_leads`.`cust_leadid`";
...
mysqli_select_db($idsconnection_mysqli, $database_idsconnection);
$query_true_salesperson2 = "SELECT * FROM `idsids_idsdms`.`sales_person` WHERE `main_dealerid` = '$did' AND  `acct_status` = '1' ORDER BY `salesperson_firstname` ASC";
