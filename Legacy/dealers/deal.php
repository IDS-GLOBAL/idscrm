...
$query_pull_dlr_deal =  "SELECT * FROM `idsids_idsdms`.`deals_bydealer` WHERE `deal_id` = '$colname_pull_dlr_deal'";
			...
			<div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-sm-12">
                    <div class="title-action">
                        ...
                        <a href="salesdesk.php" class="btn btn-warning btn-lg">Sales Desk</a>
                    </div>
                </div>
            </div>
