                    ...
                    <div class="ibox-content mailbox-content">
                        <div class="file-manager">
                            ...
                            <ul class="tag-list" style="padding: 0">
                                <li><a href=""><i class="fa fa-tag"></i> Custom Dealer 1</a></li>
                                <li><a href=""><i class="fa fa-tag"></i> Custom Dealer 2</a></li>
                                <li><a href=""><i class="fa fa-tag"></i> Custom Dealer 3</a></li>
                                <li><a href=""><i class="fa fa-tag"></i> Custom Dealer 4</a></li>
                            </ul>
