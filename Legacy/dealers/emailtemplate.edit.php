...
$query_find_dlr_template =  "SELECT * FROM `idsids_idsdms`.`email_dealer_templates` WHERE `email_dealer_templates`.`id` = '$colname_find_dlr_template'";
...
if($row_find_dlr_template['email_dealer_templates_did'] != $did){ header("Location: emailtemplates.php"); }

mysqli_select_db($idsconnection_mysqli, $database_idsconnection);
$query_query_dealer_template_cat = "SELECT * FROM `idsids_idsdms`.email_dealer_templates_types` WHERE `email_dealer_templates_types`.`email_dealer_templates_type_did` = '$did' ORDER BY `email_dealer_templates_types`.`email_dealer_templates_type_Label` ASC";
...
$query_dealer_template_types_inactive = "SELECT * FROM `idsids_idsdms`.`email_dealer_templates` WHERE `email_dealer_templates_did` = '$did' AND `email_dealer_templates_status` NOT IN (1) ORDER BY `email_dealer_templates_subject` ASC";
...
<head>
    ...
    <title>IDSCRM | Email Template</title>
