...
<head>
    ...
    <title>IDSCRM | Email Templates Sent: <?php echo $row_userDets['company']; ?></title>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="emailtemplates.php">Email Templates</a>
                        </li>
                        <li class="active">
                            <a>Viewing Templates Sent</a>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Email Templates<small>Sent</small></h5>
                    </div>
