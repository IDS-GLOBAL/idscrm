...
$query_find_fbleads = "SELECT * FROM `fbuserprofiles` WHERE `fbuserprofiles`.`fbuser_primary_did` = '$did' ORDER BY `fbuserprofiles`.`fb_onlinetime` DESC, `fbuserprofiles`.`fbuser_id` DESC";
...
<a href="fbuser.php?fbuser_id=<?php echo $row_find_fbleads['fbuser_id']; ?>&fbuser_fbid=<?php echo $row_find_fbleads['fbuser_fbid']; ?><?php echo $popvehicle_id; ?>">                            
<img src="<?php echo $row_find_fbleads['fbuser_fbpicture']; ?>?type=normal" id="profil_pic" class="pic_ready">
						...
						<a href="https://www.facebook.com/app_scoped_user_id/<?php echo $row_find_fbleads['fbuser_fbid']; ?>/" target="_blank" class="btn btn-outline btn-success dim"><i class="fa fa-facebook"></i></a>
                        </div>
                    ...
                    <div class="col-sm-8">
                        ...
                        <div title="<?php echo $row_find_fbleads['fbprofile_broswer']; ?> <?php $row_find_fbleads['fbprofile_mobile']; ?>"></div>
                        <div>Browser: <?php echo $row_find_fbleads['fbprofile_broswer']; ?></div>
                        <div>IP: <?php echo $row_find_fbleads['fbprofile_last_ip']; ?></div>
                        <div><a href="fbuser.php?fbuser_id=<?php echo $row_find_fbleads['fbuser_id']; ?>&fbuser_fbid=<?php echo $row_find_fbleads['fbuser_fbid']; ?><?php echo $popvehicle_id; ?>" class="btn btn-success btn-block wf">See Users Input</a></div>
                    </div>
