...
<head>
    ...
    <title>IDSCRM | Store: <?php echo $row_userDets['company']; ?></title>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>IDS STORE PRODUCT AND SERVICES</h5>
                    </div>
                    <div class="ibox-content">

                    <h2>Feel Free To Subscribe  To Our Products <small>Or Have Us Begin Your Next Project Or Help Your Reach Your Goals Related To Online Technology.</small> </h2>
