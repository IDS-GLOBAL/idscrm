...
$count_totalRows_find_dealerappts++;
			...
			if($row_find_dealerappts['dlr_appt_customer_id']){
				...
				$appt_url_goto = 'mysales.customer.view.php?customer_id='.$row_find_dealerappts['dlr_appt_customer_id'];
			
				}elseif($row_find_dealerappts['dlr_appt_lead_id']){

				$appt_url_goto = 'mysales.lead.view.php?leadid='.$row_find_dealerappts['dlr_appt_lead_id'];
