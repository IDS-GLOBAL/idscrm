            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="inventory.php?vstat=1">Inventory</a>
                        </li>
                        <li class="active">
...
<p>
                            <button id="continue_add_vehicle" type="button" class="btn btn-block btn-outline btn-primary">Continue</button>
                        </p>                        
...
?>
                                ...
                                <div class="form-group"><label for="vmileage" class="col-sm-2 control-label">Mileage:</label>
                                    ...
                                    <div class="col-sm-10"><input id="vmileage" type="text" class="form-control"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
...
?>
                                ...
                                <div class="form-group"><label for="vengine" class="col-sm-2 control-label">Engine:</label>

                                    <div class="col-sm-10"><input id="vengine" type="text" class="form-control"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                ...
                                <div class="form-group"><label for="vcomments" class="col-sm-2 control-label">Vehicle Comments</label>
                                    ...
                                    <div class="col-sm-10"><input id="vcomments" type="text" class="form-control"></div>
                                </div>
                ...
                <div class="col-lg-12">
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="form-group"><label class="col-sm-2 control-label">Exterior Options</label>
                                    ...
                                    <label class="checkbox">
                                        <input type="checkbox" value="1" id="Alloy_Wheels" >Alloy</label> 
                            ...
                            <div class="form-group"><label class="col-sm-2 control-label">Safety Security</label>
                                    ...
                                    <label class="checkbox">
                                        <input type="checkbox" value="1" id="inlineCheckbox3">Theft Deterrent System & Alarm</label>
                            ...
                            <div class="form-group"><label class="col-sm-2 control-label">Comfort & Convenience</label>
                                    ...
                                    <div class="col-sm-10">
                                    <label class="checkbox">
                                        <input type="checkbox" value="option2" id="inlineCheckbox2"> Auto Up/Down Front Driver's Window</label> 

                                    
                                    <label class="checkbox">
                                        <input type="checkbox" value="1" id="Bluetooth"> Bluetooth Hands-Free </label>


                                    <label class="checkbox"> 
                                    	<input type="checkbox" value="option1" id="inlineCheckbox1"> Climate Control</label> 
                                    ...
                                    <label class="checkbox">
                                        <input type="checkbox" value="1" id="Navigation_System"> Rear View Monitor </label>

                                    <label class="checkbox">
                                        <input type="checkbox" value="option3" id="Rear_view_monitor"> Rear View Monitor </label>
                    ...
                    <label class="col-sm-2 control-label">Warranty Information</label>
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <div class="input-group m-b"><input type="text" class="form-control">
