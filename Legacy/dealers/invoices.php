...
$query_inVoices = "SELECT * FROM ids_toinvoices WHERE invoice_dealerid = '$did' AND ids_toinvoices.payment_status = 'UnPaid' AND ids_toinvoices.invoice_status = 'Active' AND ids_toinvoices.payment_status not IN ('Paid') ORDER BY invoice_created_at ASC";
...
<head>
    ...
    <title>IDSCRM | Invoices: <?php echo $row_userDets['company']; ?></title>
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
         ...
         <div class="ibox-content m-b-sm border-bottom">
        	<div class="row">
                ...
                <a class="btn btn-block btn-outline btn-warning">Invoices</a>
                </div>
            	<div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Invoices <small>Sort, search</small></h5>
                    </div>
                    ...
                    <tr class="gradeX">
                                ...
                                <td><a href="invoice.php?invoice_token=<?php echo $invoiceToken; ?>&id=<?php echo $row_inVoices['invoice_id']; ?>"><?php echo $row_inVoices['invoice_duedate']; ?></a></td>
                                <td>
...
?>
                  ...
                  <a class="btn btn-primary" title="Request Invoice Or Dispute" href="ticket.create.php">
                  Dispute
                  </a>
