...
$(document).ready(function () {
	...
	$('button#dealMatrix').click( function(){
...
function addcartoinventory(){
		...
		$.post('script_insertupdate.inventory.php', {token: token, thisdid: thisdid, vvin: vvin, vmileage: vmileage, vstockno: vstockno, vmileage: vmileage, vin_year: vin_year, vin_make: vin_make, vmodel: vmodel, vtrim: vtrim, vexterior_color: vexterior_color, vexterior_color_hex: vexterior_color_hex, vinterior_color: vinterior_color, vinterior_color_hex: vinterior_color_hex, vcylinders: vcylinders, vfueltype: vfueltype, vtransm: vtransm, vlivestatus: vlivestatus, vcondition: vcondition, vrprice: vrprice, vspecialprice: vspecialprice, vdprice: vdprice, vpurchasecost: vpurchasecost, vdlrpack: vdlrpack, vaddedcost: vaddedcost, vinlength: vinlength }, 
