...
// make a unix time stamp for birthday in customers. update real pearson id with a script_switch_realperson.php?creditapp=$appid
		     ...
		     $('div#primary_app_section').load('content/body.single.full_app.edit.php?type=Primary&app_id='+app_id+'&key='+applicant_app_token);
...
$('button#editApp').on('click', function(){
			 ...
			 window.location.replace('creditapp.edit.php?app_id='+app_id+'&keytoken='+applicant_app_token);
...
$('button#load_primary_creditapp').click( function(){
		     ...
		     $('div#primary_app_section').load('content/body.single.full_app.edit.php?type=Primary');
...
$('button#load_joint_creditapp').click( function(){
				...
				$('div#primary_app_section').removeClass('col-sm-12').addClass('col-sm-6');
		     	...
		     	$('div#joint_app_section').load('content/body.single.full_app.edit.php?type=Joint&joincoappid='+credit_app_fullblown_id+'&appkey='+applicant_app_token);
...
$.post('script_update_creditapp.php', {
