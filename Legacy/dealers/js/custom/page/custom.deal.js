...
$(document).ready(function(){
	...
	$('button#save_thisdeal').click(function(){
			
			
		update_salesdesk_deal();	
	...
	$('button#close_thisdeal').click(function(){
			
			
		update_salesdesk_deal();
		close_salesdesk_deal();
...
function close_salesdesk_deal(){
	
	console.log('Closing Deal');
	
	alert('Once This Is Done There is No Undoing');
}

function update_salesdesk_deal(){

	console.log('Running Posting');
	
	var deal_id = $('input#deal_id').val();
...
console.log('Posting: '+vehicle_id);
	...
	$.post('script_update_salesdesk.php?vid='+vehicle_id, {
		deal_id: deal_id,
