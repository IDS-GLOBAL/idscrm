...
$('button#switch_repair_shops').click(function(){
		...
		$('button#savenewappointmentModal').click( function(){
			...
			if(dlr_appt_dlrtimezone == 'No timezone found'){ alert("Sorry No timezone was found!"); }
