...
$('div#save_credit_app_bar').hide();





$('span#usthisexistingappnumber').click( function(){
		
											 
		var credit_app_id = $(this).parent().parent('tr').attr('id');
		
		$('input#pulled_app_id').val(credit_app_id);
		use_joint_appid();
});
...
$('button#load_primary_creditapp').click( function(){
			  ...
			  $('div#start_joint_app_section').show();
		
		      $('div#primary_app_section').load('content/mysales.body.single.full_app.php?type=Primary');
...
$('button#load_joint_creditapp').click( function(){
				...
				$('div#primary_app_section').removeClass('col-sm-12').addClass('col-sm-6');
		     	...
		     	$('div#joint_app_section').load('content/mysales.body.coapp.full_app.php?type=Joint');
				
				
				$('div#joint_app_section').show();
				
				$('button#load_joint_creditapp').hide();

				$('button#delete_joint_creditapp').show();
...
$('button#delete_joint_creditapp').click( function(){

				$('button#delete_joint_creditapp').hide();
				
				$('div#joint_app_section').hide();
				$('div#primary_app_section').removeClass('col-sm-6').addClass('col-sm-12');
				$('button#recover_joint_creditapp').show();

				$("div#save_single_app_action").show();
				$("div#save_co_app_action").hide();
			

});

$('button#recover_joint_creditapp').click( function(){

				$('button#recover_joint_creditapp').hide();
				$('div#primary_app_section').removeClass('col-sm-12').addClass('col-sm-6');
				$('div#joint_app_section').show();
				$('button#delete_joint_creditapp').show();
...
$.post('script_mysales.create_creditapp.php', {
