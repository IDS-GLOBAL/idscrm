...
// make a unix time stamp for birthday in customers. update real pearson id with a script_switch_realperson.php?creditapp=$appid
		     ...
		     $('div#primary_app_section').load('content/mysales.body.single.full_app.edit.php?type=Primary&app_id='+app_id+'&key='+applicant_app_token);
...
$('button#editApp').on('click', function(){
			 ...
			 window.location.replace('mysales.creditapp.edit.php?app_id='+app_id+'&keytoken='+applicant_app_token);
});
...
$('button#load_primary_creditapp').click( function(){
		     ...
		     $('div#primary_app_section').load('content/mysales.body.single.full_app.edit.php?type=Primary');
