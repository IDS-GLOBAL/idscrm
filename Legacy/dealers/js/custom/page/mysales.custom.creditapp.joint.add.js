...
function use_joint_appid(){
			...
			if(pulled_app_id){
			 ...
			 $('div#joint_app_section').load('content/mysales.body.single.full_app.pulled.edit.php?pulled_app_id='+pulled_app_id);
...
$.post('script_mysales.create_creditapp.joint.php?coapp=Y', {
...
$.post('script_mysales.build_joint_creditapp.php', {
