...
$query_view_thislead = "SELECT * FROM cust_leads WHERE cust_leadid = '$colname_view_thislead'";
...
mysqli_select_db($idsconnection_mysqli, $database_idsconnection);
$query_options_years = "SELECT * FROM `year_options` ORDER BY `year_options`.`year_id` ASC";
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <a href="lead.view.php?leadid=<?php echo $row_view_thislead['cust_leadid']; ?>"><strong>Lead View</strong></a>
			...
			<div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-sm-12">
                    <div class="title-action">
                        ...
                        <a href="leads.php" class="btn btn-primary btn-lg">Leads</a>                    
                        <a href="lead.view.php?leadid=<?php echo $row_view_thislead['cust_leadid']; ?>" class="btn btn-primary btn-lg">Lead View</a>
                        <a class="btn btn-warning btn-lg">Editing Lead</a>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="col-sm-10">
                        	<textarea class="left-float form-control" id="cust_bodynote" rows="4" cols="50"></textarea>                        		
...
<div class="row">
    ...
    <script src="js/custom/page/custom.lead.edit.js"></script>
