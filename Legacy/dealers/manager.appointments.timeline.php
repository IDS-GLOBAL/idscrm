...
$query_appointments_frm_now = "SELECT * FROM dealers_appointments WHERE dlr_appt_did = $did ORDER BY dealers_appointments.dlr_appt_startunixtime DESC";
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="manager.appointments.php">Appointment Calendar</a>
                    </li>
                    <li class="active">
                        ...
                        <div id="vertical-timeline" class="vertical-container dark-timeline center-orientation">
                            ...
                            <div class="vertical-timeline-block">
                                ...
                                <div class="vertical-timeline-content">
                                    ...
                                    <a href="manager.appointment.php?appt_token=<?php echo $row_appointments_frm_now['dlr_appt_token']; ?>" class="btn btn-sm btn-primary"> Appointment View</a>
