			...
			<div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-sm-12">
                    <div class="title-action">
                        ...
                        <a href="manager.creditapp.add.php" class="btn btn-primary btn-lg">Create A New Credit Application</a>
                    </div>
                </div>
            </div>
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <tbody>
                    <?php if($totalRows_find_creditapps != 0): ?>
                      ...
                      <?php do { ?>
                            <?php
								...
								$credit_app_link = "credit-app.joint.php?manager.credit-app.php=$credit_app_id&keytoken=$applicant_app_token&app_token2=$applicant_app_joint_token";
								...
								$credit_app_link = "manager.credit-app.php?app_id=$credit_app_id&keytoken=$applicant_app_token";
