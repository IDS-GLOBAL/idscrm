			...
			<div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-sm-12">
                    <div class="title-action">
                        <a href="manager.departments.php" class="btn btn-primary btn-lg">Departments</a>                    
...
<script type="text/javascript" src="js/custom/page/manager.department.add.js"></script>
</body>
