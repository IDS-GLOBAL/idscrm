...
if($fbuser_primary_did != $did){
  header('Location: manager.facebookusers.php');
}

mysqli_select_db($idsconnection_mysqli, $database_idsconnection);
$query_find_fbdlr_leads = "SELECT * FROM `cust_leads` WHERE `cust_leads`.`fbid` = '$fbuser_id' AND `cust_leads`.`cust_dealer_id` = '$did' ORDER BY cust_lead_created_at DESC";
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="manager.facebookusers.php">Face Book Users</a>
                        </li>
                        <li class="active">
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div>
							...
							?>
                                ...
                                <p>
                                    Mobile Phone: <?php echo $row_find_fbuser['applicant_cell_phone']; ?><br />
                                    Home Phone: <?php echo $row_find_fbuser['applicant_main_phone']; ?>
