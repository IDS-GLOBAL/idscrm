...
<!-- START View Inventory Bar -->
   ...
   <?php 
	...
	?>
                        ...
                        <a href="manager.inventory.php?vstat=1" class="btn <?php echo $inventory_btn_live; ?> btn-lg">VIEW <?php echo $row_vehiclesOnHld['LIVE']; ?> LIVE</a>
                        <a href="manager.inventory.php?vstat=0" class="btn <?php echo  $inventory_btn_hold; ?> btn-lg">VIEW <?php echo $row_vehiclesOnHld['HOLD']; ?> HOLD</a>
                        <a href="manager.inventory.php?vstat=9" class="btn <?php echo $inventory_btn_sold; ?> btn-lg">VIEW <?php echo $row_vehiclesOnHld['SOLD']; ?> SOLD</a>
                    </div>
                </div>
            </div>
<!-- END View Inventory Bar -->
...
<strong>Interior Color: </strong><?php echo $row_LiveVehicles['vicolor_txt']; ?><br /> <br />
                        ...
                        <div class="btn btn-white">
                        	<a href="manager.inventory.edit.php?vid=<?php echo $row_LiveVehicles['vid']; ?>">View/Edit</a>
                        </div>
                        <br />
                        <br />
                        <div class="btn btn-white">
                            <a href="manager.vphotos.php?vid=<?php echo $row_LiveVehicles['vid']; ?>">View Photos</a>
                        </div>
                        <br />
                        <br />
                        <div class="btn btn-white">
                            <a href="manager.upload-vphotos.php?vid=<?php echo $row_LiveVehicles['vid']; ?>">Upload Photos</a>
                        </div>
...
<?php endif; ?>                
    ...
    <script src="js/manager.ids.inventory.js"></script>
