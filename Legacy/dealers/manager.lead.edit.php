...
global $idsconnection;
			...
			mysqli_select_db($idsconnection_mysqli, $database_idsconnection);
			echo $update_seenlead = "UPDATE `idsids_idsdms`.`cust_leads` SET `cust_seenbydlr` = '1' WHERE `cust_leadid` = '$cust_lead_id'";
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="manager.leads.php">Leads</a>
                        </li>
                        <li class="active">
                            <a href="manager.lead.view.php?leadid=<?php echo $row_view_thislead['cust_leadid']; ?>"><strong>Lead View</strong></a>
			...
			<div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-sm-12">
                    <div class="title-action">
                        ...
                        <a href="manager.leads.php" class="btn btn-primary btn-lg">Leads</a>                    
