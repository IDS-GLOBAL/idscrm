...
<body>
	...
	<div class="row">
			<div class="col-lg-12">
                ...
                <a class="btn btn-info  dim btn-large-dim btn-outline" target="_parent" href="manager.lead.edit.php?leadid=<?php echo $row_view_thislead['cust_leadid']; ?>"><i class="fa fa-pencil-square-o fa-3x"></i></a>
