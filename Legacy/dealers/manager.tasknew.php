...
mysqli_select_db($idsconnection_mysqli, $database_idsconnection);
$query_find_singledealertask =  "SELECT * FROM `dealers_tasks` WHERE `dealers_tasks`.`task_token` = %s AND `dealers_tasks`.`task_did` = '$did'", GetSQLValueString($colname_find_singledealertask, "text"));
