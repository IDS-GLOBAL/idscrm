...
$query_find_dlr_creditapp =  sprintf("SELECT * FROM `idsids_idsdms`.`credit_app_fullblown` WHERE `credit_app_fullblown_id` = %s AND `applicant_did` = '$did'", GetSQLValueString($colname_find_dlr_creditapp, "int"));
...
?>
            ...
            <div class="row">
                ...
                <div id="primary_app_section" class="col-sm-12">
					<?php //include("content/body.single.full_app.pulled.edit.php"); ?>
...
<div class="row">
	...
	<script src="js/custom/page/mysales.custom.creditapp.edit.js"></script>
