...
$MM_restrictGoTo = "../dealer/index.php";
...
mysqli_select_db($idsconnection_mysqli, $database_idsconnection);
$query_cust_lead =  "SELECT * FROM `idsids_idsdms`.`cust_leads` WHERE `cust_leads`.`cust_leadid` = '$colname_cust_lead'";
...
mysqli_select_db($idsconnection_mysqli, $database_idsconnection);
$query_leadVehicle = "SELECT * FROM `idsids_idsdms`.`vehicles` WHERE `vehicles`.`vid` = '$vid'";
...
mysqli_select_db($idsconnection_mysqli, $database_idsconnection);
$query_salesPerson1 = "SELECT * FROM `idsids_idsdms`.`sales_person` WHERE `salesperson_id` = '$sid1'";
...
mysqli_select_db($idsconnection_mysqli, $database_idsconnection);
$query_salesPerson2 = "SELECT * FROM `idsids_idsdms`.`sales_person` WHERE `salesperson_id` = '$sid2'";
...
$pdf->Cell(45,5,'Source: '.$leadsource, 1,0,'L');
$pdf->Cell(45,5,'        *Special Rates May Apply *',0,1,'L');
else:
