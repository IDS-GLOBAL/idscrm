...
$query_userDets =  "SELECT * FROM `idsids_idsdms`.`dealers`, `idsids_idsdms`.`sales_person` WHERE `sales_person`.`main_dealerid` = `dealers`.`id` AND `sales_person`.`salesperson_email` = %s";
