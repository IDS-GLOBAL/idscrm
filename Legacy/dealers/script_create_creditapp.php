...
mysqli_select_db($idsconnection_mysqli, $database_idsconnection);
$query_find_coapplicantbytoken = "SELECT * FROM `idsids_idsdms`.`credit_app_fullblown` WHERE `credit_app_fullblown`.`applicant_app_token` = '$token' AND `credit_app_fullblown`.`applicant_did` = '$did' ORDER BY `credit_app_fullblown`.`credit_app_fullblown_id` ASC";
