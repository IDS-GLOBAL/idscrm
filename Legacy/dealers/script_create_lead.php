...
// , $_POST['cust_other_income'], $_POST['cust_other_income_amount'], $_POST['cust_gross_other_income_frequency'], $_POST['cust_downpayment'], $_POST['cust_desiredpymt'], $_POST['cust_vehicle_id'], $_POST['cust_vstockno'], $_POST['cust_vyear'], $_POST['cust_vmake'], $_POST['cust_vmodel'], $_POST['cust_vtrim'], $_POST['cust_vmiles'], $_POST['cust_vbody'], $_POST['cust_vsellingprice'], $_POST['counter_offer'], $_POST['counter_offer2'], $_POST['tradeYes'], $_POST['tradePayment'], $_POST['tradePayoff'], $_POST['tradeVin'], $_POST['tradeYear'], $_POST['tradeMake'], $_POST['tradeModel'], $_POST['tradeTrim'], $_POST['tradeMiles']
...
$run_create_cust_lead_sql = mysqli_query($idsconnection_mysqli, $create_cust_lead_sql);
...
//echo $log;
	...
	<script>
	 setTimeout(function () {
		console.log('Redirectiong to leads.php');
