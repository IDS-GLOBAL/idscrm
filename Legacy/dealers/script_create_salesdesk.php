...
$insert_salesdesk_sql = "
INSERT INTO `idsids_idsdms`.`deals_bydealer` SET
    `deal_token` = '$salesdeskToken',
...
$run_insert_salesdesk_sql = mysqli_query($idsconnection_mysqli, $insert_salesdesk_sql);
