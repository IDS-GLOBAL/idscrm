...
if(!$found_vid){
		...
		echo "<script> window.location.replace('script_last_vehicle_added.php'); </script>";
		...
		echo "<script> window.location.replace('inventory.edit.php?token=$vid'); </script>";
