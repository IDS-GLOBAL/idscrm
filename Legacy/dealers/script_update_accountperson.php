...
if(isset($_POST['account_id'], $_POST['account_title'], $_POST['account_department_id'], $_POST['team_id'], $_POST['team_name'], $_POST['account_outgoing_emails'], $_POST['account_accept_payments'], $_POST['acid_addinv_2main_dealerid'], $_POST['account_firstname'], $_POST['account_lastname'], $_POST['account_nickname'], $_POST['collector_acct_status'], $_POST['account_main_number'], $_POST['account_phone_ext'], $_POST['account_mobilephone_number'], $_POST['website_url'], $_POST['sales_pitch'], $_POST['prof_motto'], $_POST['prof_hometown'], $_POST['prof_sportsteam'], $_POST['prof_dreamvact'], $_POST['prof_favfood'], $_POST['prof_favtvshow'], $_POST['goal_monthly_monies_collect'])){


$account_id = mysqli_real_escape_string($idsconnection_mysqli, trim($_POST['account_id']));
...
$acid_addinv_2main_dealerid = mysql_real_escape_string($_POST['acid_addinv_2main_dealerid']);
...
$goal_monthly_monies_collect= mysqli_real_escape_string($idsconnection_mysqli, trim($_POST['goal_monthly_monies_collect']));
 ...
 $update_account_sql = "
UPDATE `idsids_idsdms`.`account_person` SET
	...
	WHERE
	`account_person_id` = '$account_id'
";

$run_update_account_sql = mysqli_query($idsconnection_mysqli, $update_account_sql);
