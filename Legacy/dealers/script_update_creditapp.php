...
$title_name = mysqli_real_escape_string($idsconnection_mysqli, trim($_POST['title_name']));
...
$user_comments_trade_notes = mysqli_real_escape_string($idsconnection_mysqli, trim($_POST['user_comments_trade_notes']));
 ...
 echo $credit_app_fullblown_id_sql = "
UPDATE `idsids_idsdms`.`credit_app_fullblown` SET
	...
	`applicant_titlename` = '$title_name',
...
echo '
<script>
	//window.location.replace("credit-apps.php");
</script>
';
