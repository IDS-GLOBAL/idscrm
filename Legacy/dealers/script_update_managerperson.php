...
if(isset($_POST['manager_id'], $_POST['manager_title'], $_POST['manager_department_id'], $_POST['team_id'], $_POST['team_name'], $_POST['manager_reassign_leads'], $_POST['manager_approvedeals'], $_POST['mgrid_addinv_2main_dealerid'], $_POST['manager_firstname'], $_POST['manager_lastname'], $_POST['manager_nickname'], $_POST['manager_main_number'], $_POST['manager_phone_ext'], $_POST['manager_mobilephone_number'], $_POST['website_url'], $_POST['sales_pitch'], $_POST['prof_motto'], $_POST['prof_hometown'], $_POST['prof_sportsteam'], $_POST['prof_dreamvact'], $_POST['prof_favfood'], $_POST['prof_favtvshow'], $_POST['goal_cars_monthly'], $_POST['goal_appts_monthly'], $_POST['acct_status'])){
...
$manager_id = mysqli_real_escape_string($idsconnection_mysqli, trim($_POST['manager_id']));
...
$team_goal_appts_monthly= mysqli_real_escape_string($idsconnection_mysqli, trim($_POST['goal_appts_monthly']));
 ...
 $update_manager_sql = "
UPDATE `idsids_idsdms`.`manager_person` SET
...
$run_update_manager_sql = mysqli_query($idsconnection_mysqli, $update_manager_sql);
