...
do {  
?>
<option value="<?php echo $row_system_tasks['task_id']?>"><?php echo $row_system_tasks['task_label']?></option>
<?php
        ...
        <div class="form-group">
           <label class="font-normal">Time To Start Task:</label>
            <div class='input-group date' id='newtaskstart'>
                <input id="taskstart_unixtime" name="taskstart_unixtime" type='text' class="form-control" value="" disabled="true" />
    ...
    <div class='col-md-5'>
        <div class="form-group">
            ...
            <div class='input-group date' id='newtaskend'>
                <input id="taskend_unixtime" name="taskend_unixtime" type='text' class="form-control" value="" disabled="true" />
                <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span>
                </span>
            </div>
        </div>
