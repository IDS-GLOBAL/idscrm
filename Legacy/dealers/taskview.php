...
mysqli_select_db($idsconnection_mysqli, $database_idsconnection);
$query_find_singledealertask =  "SELECT * FROM `idsids_idsdms`.`dealers_tasks` WHERE `dealers_tasks`.`task_token` = '$colname_find_singledealertask ' AND `dealers_tasks`.`task_did` = '$did'";
