...
define ('PDF_HEADER_TITLISH', "Window Sticker");
...
$pdf->SetAuthor('Benjamin Carter');
$pdf->SetTitle('Vehicle Window Sticker');
$pdf->SetSubject('IDSCRM PDF VERSION');
$pdf->SetKeywords('TCPDF, PDF, automobile, vehicle, dealer, idscrm');

// set default header data
$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, PDF_HEADER_TITLISH.' ', PDF_HEADER_STRING);
...
$html = "<div style='text-align:center'>$vcondition $vyear $vmake $vmodel $vtrim</div>";
...
// output some RTL HTML content
$html = "<div style='text-align:center'><img src='$vthubmnail_file_path' alt='test alt attribute' width='120' height='90' border='0' /> $vthubmnail_file_path </div>";
...
List example:
<ol>
	<li><img src="$vthubmnail_file_path" alt="test alt attribute" width="30" height="30" border="0" /> test image</li>
	<li><b>bold text</b></li>
...
<img src="$vthubmnail_file_path" alt="test alt attribute" width="100" height="100" border="0" /><img src="../tcpdf/examples/images/tcpdf_box.svg" alt="test alt attribute" width="100" height="100" border="0" /><img src="../tcpdf/examples/images/logo_example.jpg" alt="test alt attribute" width="100" height="100" border="0" />
</div>';
...
<tr><td><img src="img/a5.jpg" border="0" height="41" width="41" /></td></tr>
<tr style="text-align:left;"><td><img src="img/a5.jpg" border="0" height="41" width="41" align="top" /></td></tr>
<tr style="text-align:center;"><td><img src="img/a5.jpg" border="0" height="41" width="41" align="middle" /></td></tr>
<tr style="text-align:right;"><td><img src="img/a5.jpg" border="0" height="41" width="41" align="bottom" /></td></tr>
<tr><td style="text-align:left;"><img src="img/a5.jpg" border="0" height="41" width="41" align="top" /></td></tr>
<tr><td style="text-align:center;"><img src="img/a5.jpg" border="0" height="41" width="41" align="middle" /></td></tr>
<tr><td style="text-align:right;"><img src="img/a5.jpg" border="0" height="41" width="41" align="bottom" /></td></tr>
</table>';
...
<ul style="font-size:14pt;list-style-type:img|png|4|4|img/a5.jpg">
