...
<head>
    ...
    <title>IDSCRM | Contact Us Page Website</title>
    ...
    <div id="wrapper">
        ...
        <?php include("_nav_top.php"); ?>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Website Contact Us Page</h2>
                    <ol class="breadcrumb">
                        <li>
                            <a href="dashboard.php">Dash Board</a>
                        </li>
                        <li>
                            <a>Website Contact Us Page</a>
                        </li>
                        <li class="active">
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Edit Your Webiste Contact Us Page Here</h5>
                        ...
                        <div class="ibox-content no-padding">
                            ...
                            <div class="click2edit wrapper">
                            	...
                            	<?php echo $row_userDets['contactus']; ?>
