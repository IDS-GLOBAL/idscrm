...
<head>
    ...
    <title>IDSCRM | Directions Page Website</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <?php include("_nav_top.php"); ?>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Website Directions Page</h2>
                    <ol class="breadcrumb">
                        <li>
                            <a href="dashboard.php">Dash Board</a>
                        </li>
                        <li>
                            <a>Website Directions Page</a>
                        </li>
                        <li class="active">
                            <strong>Edit Directions Page</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Edit Your Webiste Directions Page Here</h5>
                        ...
                        <div class="ibox-content no-padding">
                            ...
                            <div class="click2edit wrapper">
                            	...
                            	<?php echo $row_userDets['directions']; ?>
    ...
    <script type="text/javascript" src="js/custom/page/custom.website.directions.js"></script>
