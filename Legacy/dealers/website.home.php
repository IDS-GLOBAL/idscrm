...
<head>
    ...
    <title>IDSCRM | Home Page Website</title>
...
<body>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Edit You Webiste Home Page Here</h5>
    ...
    <!-- SUMMERNOTE -->
    <script src="js/plugins/summernote/summernote.min.js"></script>
    <script type="text/javascript" src="js/custom/page/custom.website.home.js"></script>
