                                      ...
                                      <div class="row">
                                        ...
                                        <div class="hr-line-dashed"></div>
                                            ...
                                            <div id="update_reocurring_invoice_fees_box">
                                                    ...
                                                    <div id="recurEditInvoiceInnerFees" class="inner-fees">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                            <div class="form-group">
                                                                    <label for="edit_recurring_tax_total" class="col-sm-12 control-label">Tax total <small>Useless no need to use...</small></label>
                                                                <div class="col-sm-10">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label for="edit_recurring_invoice_taxtotal" class="col-sm-12 control-label">Invoice Taxtotal</label>
                                                                    <div class="col-sm-10">
