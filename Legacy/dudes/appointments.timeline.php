...
<head>
    ...
    <title>IDSCRM | Appointments Timeline<?php echo $row_userDudes['dudes_firstname']; ?><?php echo $row_userDudes['dudes_lname']; ?></title>
...
<?php include("analyticstracking.php"); ?>
    <div id="wrapper">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                <h2>Appointments Timeline View</h2>
                <ol class="breadcrumb">
                    <li>
              ...
              <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Appointments Timeline <small>Sort, search</small></h5>
                    </div>
