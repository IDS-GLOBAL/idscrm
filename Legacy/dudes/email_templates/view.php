...
?>
<?php
echo $email_systm_templates_body = $row_pulltemplate['email_systm_templates_body'];
...
<tr>
<td width='600' align='left' valign='bottom' style='color:#ffffff;line-height:16px;font-size:11px;font-family:Arial,Helvetica,sans-serif;padding-bottom:10px;padding-left:15px;padding-right:15px;padding-top:10px'>&copy; Copyright 2016 IDSCRM.COM LLC. All rights reserved.<br>
