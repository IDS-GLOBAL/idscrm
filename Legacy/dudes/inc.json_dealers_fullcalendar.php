...
return $milliseconds;
		...
		$query_dlr_tasks = "SELECT * FROM `dudes_tasks` WHERE `dudes_tasks`.`task_dudesid` = '$dudesid'";
		$find_dlr_tasks = mysqli_query($idsconnection_mysqli, $query_dlr_tasks, $tracking);
...
$count_totalRows_find_dlr_tasks++;
			...
			$task_prospectdlrid = $row_find_dlr_tasks['task_prospectdlrid'];
			...
			$task_url_goto = "prospect.dealer.php?prospctdlrid=$task_prospectdlrid";
...
return $milliseconds;
		...
		$query_dealerappts = "SELECT * FROM `dealers_appointments` WHERE  `dealers_appointments`.`ids_sys_owned` IS NULL";
...
$count_totalRows_find_dealerappts++;
			...
			$dlr_appt_prospectdlrid = $row_find_dealerappts['dlr_appt_prospectdlrid'];
			...
			if(!$appt_url_goto){
				...
				$appt_url_goto = "prospect.dealer.php?prospctdlrid=$dlr_appt_prospectdlrid";
