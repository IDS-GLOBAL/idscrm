...
mysqli_select_db($idsconnection_mysqli, $database_idsconnection);
$query_dealerInvoices = "SELECT * FROM `idsids_idsdms`.`ids_toinvoices` ORDER BY `ids_toinvoices`.`invoice_created_at` DESC";
...
<div class="container">
  ...
  <tr>
    ...
    <td><?php echo $row_dealerInvoices['invoice_dealerid']; ?></td>
    <td><a href="update-invoice.php?invoice_id=<?php echo $row_dealerInvoices['invoice_id']; ?>"><?php echo $row_dealerInvoices['invoice_status']; ?></a></td>
    ...
    <td>&nbsp;</td>
    <td><a href="?delete_id=<?php echo $row_dealerInvoices['invoice_id']; ?>"><img src="images/pimpa_no.gif" alt="picture" width="15" height="15" class="tabpimpa"></a></td>
  </tr>
