...
mysqli_select_db($idsconnection_mysqli, $database_idsconnection);
$query_queryInvoices = "SELECT * FROM `idsids_idsdms`.`ids_toinvoices`";
        ...
        <div class="gadget">
          ...
          <div class="gadget_content">
            <div class="subblock">
              ...
              <p><a href="create-invoice.php">Create Invoice &raquo;</a><br /> Add, Edit, and Delete stored invoice line items.</p>
              <p><a href="invoice-pending.php">Search Invoices &raquo;</a><br /> Search all invoices in the system, regardless of status.</p>
              <p><a href="invoice-pending.php">Pending Invoices &raquo;</a><br /> View all pending invoices.</p>              
              <p><a href="invoice-recurring.php">Recurring Invoices &raquo;</a><br /> View and search all recurring invoices in the system.</p>
              <p><a href="create-fees.php">Stored Invoice Fees/Items &raquo;</a><br /> 
              Add, Edit, and Delete stored invoice line items.</p>              

              <p><a href="create-recurring-invoice.php">Create Recurring Invoice &raquo;</a><br /> Create a new recurring invoice.</p>              
