...
console.log('pullanewtemplatefile: '+pullanewtemplatefile);
		...
		$('a#update_dudes_pitchtemplate').click(function(){

		//debugger;
		var dudes_salespitch_id = $('input#dudes_salespitch_id').val();
		...
		var dudes_salespitch_body = $('.note-editable').html();
			...
			$.post('script_update_newpitchtemplate.php', {
			...
			window.location.replace('pitchtemplates.php');
