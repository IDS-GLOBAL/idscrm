...
mysqli_select_db($idsconnection_mysqli, $database_idsconnection);
$query_dealer_leads = "SELECT * FROM `idsids_idsdms`.`cust_leads` WHERE cust_dealer_id = '$did' ORDER BY cust_leads.cust_lead_created_at DESC";
...
mysqli_select_db($idsconnection_mysqli, $database_idsconnection);
$query_sales_persons = "SELECT * FROM sales_person WHERE main_dealerid = '$did' ORDER BY salesperson_id DESC";
...
$query_dealer_activity = "SELECT * FROM dudes_activity WHERE dudes_dlr_did = '$did' ORDER BY dudes_dlr_created_at ASC";
$dealer_activity = mysqli_query($idsconnection_mysqli, $query_dealer_activity, $tracking);
...
$query_livehelp_credentials = "SELECT * FROM livehelp_users WHERE livehelp_users.email = '$dealer_email'";
$livehelp_credentials = mysqli_query($idsconnection_mysqli, $query_livehelp_credentials, $idschatconnection);
