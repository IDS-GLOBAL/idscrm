...
<?php
	...
	$inertDudeActivityStr = "INSERT INTO `idsids_tracking_idsvehicles`.`dudes_activity` (`dudes_dlr_actid`, `dudes_dlr_did`, `dudes_dlr_did_prospctid`, `dudes_dlr_dude_id`, `dudes_dlr_dude_name`, `dudes_dlr_body`, `dudes_dlr_created_at`) VALUES (NULL, '$id', '', '$dudesid', '$myname', 'Edited Recurring Invoice for Dealer $id', CURRENT_TIMESTAMP)";
...
$result = mysqli_query($idsconnection_mysqli, $inertDudeActivityStr);
	...
	//header("Location: invoices-recurring.php");
