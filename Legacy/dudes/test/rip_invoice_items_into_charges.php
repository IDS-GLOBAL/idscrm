...
$query_queryDealer =  "SELECT * FROM `idsids_idsdms`.`dealers` WHERE `dealers`.`id` = '$colname_queryDealer'";
...
mysqli_select_db($idsconnection_mysqli, $database_idsconnection);
$query_queryInvoice =  "SELECT * FROM 
...
ORDER BY 
`ids_toinvoices_recurring`.`invoice_status` ASC,
...
<div class="subblock">
              ...
              <tr>
                ...
                <th width="180px">&amp; Description <a href="/idscrm/dudes/test/rip_invoice_items_into_charges.php?invoice_id=<?php echo $nextme++; ?>">Next Me</a> </th>
...
?>
			  ...
			  <tr>
				...
				<td><input <?php if (!(strcmp($row_queryInvoice['tax1'],"Y"))) {echo "checked=\"checked\"";} ?> <?php if (!(strcmp($row_queryInvoice['tax1'],1))) {echo "checked=\"checked\"";} ?> name='tax1' id='tax1' type='checkbox' onchange='sumForm()' value="<?php echo $row_queryInvoice['tax1']; ?>" class='utc' /></td>
				 ...
				 //echo @$itemline; 
						...
						$recur_charges_toinvoicenumber = $invoice_number;
						$recur_charges_invoiceToken = $invoice_tokenid;
						$recur_charges_fee_id = $row_queryInvoice['fee_id1'];
						$recur_charges_fee_type = $row_queryInvoice['fee_description1'];
						$recur_charges_fee_description = $row_queryInvoice['fee_description1'];
						$recur_charges_fee_qty = $row_queryInvoice['quantity1'];
						
						$recur_charges_fee_price = $row_queryInvoice['fee_price1'];
						$recur_charges_amount = $row_queryInvoice['fee_amount1'];
			...
			echo 	$check_1_sql = "SELECT * FROM `idsids_idsdms`.`ids_chargestorecurring`
							WHERE
								`ids_chargestorecurring`.`recur_charges_invoice_id` = '$colname_queryInvoice'
								AND
...
?>
			...
			echo 	$check_2_sql = "SELECT * FROM `idsids_idsdms`.`ids_chargestorecurring`
							WHERE
								`ids_chargestorecurring`.`recur_charges_invoice_id` = '$colname_queryInvoice'
								AND
								`recur_charges_fee_id` = '$recur_charges_fee_id'
...
?>
			  ...
			  <tr>
				...
				<td><input <?php if (!(strcmp($row_queryInvoice['tax3'],"Y"))) {echo "checked=\"checked\"";} ?> name='tax3' type='checkbox' class='utc' id='tax3' value="<?php echo $row_queryInvoice['tax3']; ?>" onchange="sumForm()" /></td>
				 ...
				 //echo @$itemline; 
						...
						$recur_charges_fee_type = $row_queryInvoice['fee_description3'];
						$recur_charges_fee_description = $row_queryInvoice['fee_description3'];
			...
			echo 	$check_3_sql = "SELECT * FROM `idsids_idsdms`.`ids_chargestorecurring`
							WHERE
								`ids_chargestorecurring`.`recur_charges_invoice_id` = '$colname_queryInvoice'
								AND
								`recur_charges_fee_id` = '$recur_charges_fee_id'
...
?>
			  ...
			  <tr>
				...
				<td><input <?php if (!(strcmp($row_queryInvoice['tax4'],"Y"))) {echo "checked=\"checked\"";} ?> name='tax4' type='checkbox' class='utc' id='tax4' value="<?php echo $row_queryInvoice['tax4']; ?>" onchange="sumForm()" /></td>
				 ...
				 //echo @$itemline; 
						...
						$recur_charges_fee_type = $row_queryInvoice['fee_description4'];
						$recur_charges_fee_description = $row_queryInvoice['fee_description4'];
			...
			echo 	$check_4_sql = "SELECT * FROM `idsids_idsdms`.`ids_chargestorecurring`
							WHERE
								`ids_chargestorecurring`.`recur_charges_invoice_id` = '$colname_queryInvoice'
								AND
								`recur_charges_fee_id` = '$recur_charges_fee_id'
...
?>
			  ...
			  <tr>
				...
				<td><input <?php if (!(strcmp($row_queryInvoice['tax5'],"Y"))) {echo "checked=\"checked\"";} ?> name='tax5' type='checkbox' class='utc' id='tax5' value="<?php echo $row_queryInvoice['tax5']; ?>" onchange="sumForm()" /></td>
				 ...
				 //echo @$itemline; 
						...
						$recur_charges_fee_type = $row_queryInvoice['fee_description5'];
						$recur_charges_fee_description = $row_queryInvoice['fee_description5'];
			...
			echo 	$check_5_sql = "SELECT * FROM `idsids_idsdms`.`ids_chargestorecurring`
							WHERE
								`ids_chargestorecurring`.`recur_charges_invoice_id` = '$colname_queryInvoice'
								AND
								`recur_charges_fee_id` = '$recur_charges_fee_id'
...
?>
			  ...
			  <tr>
				...
				<td><input <?php if (!(strcmp($row_queryInvoice['tax6'],"Y"))) {echo "checked=\"checked\"";} ?> name='tax6' type='checkbox' class='utc' id='tax6' value="<?php echo $row_queryInvoice['tax6']; ?>" onchange="sumForm()" /></td>
				 ...
				 //echo @$itemline; 
						...
						$recur_charges_fee_type = $row_queryInvoice['fee_description6'];
						$recur_charges_fee_description = $row_queryInvoice['fee_description6'];
			...
			echo 	$check_6_sql = "SELECT * FROM `idsids_idsdms`.`ids_chargestorecurring`
							WHERE
								`ids_chargestorecurring`.`recur_charges_invoice_id` = '$colname_queryInvoice'
								AND
								`recur_charges_fee_id` = '$recur_charges_fee_id'
...
?>
			  ...
			  <tr>
                ...
                <?php
				 ...
				 //echo @$itemline; 
						...
						$recur_charges_fee_type = $row_queryInvoice['fee_description7'];
						$recur_charges_fee_description = $row_queryInvoice['fee_description7'];
			...
			echo 	$check_7_sql = "SELECT * FROM `idsids_idsdms`.`ids_chargestorecurring`
							WHERE
								`ids_chargestorecurring`.`recur_charges_invoice_id` = '$colname_queryInvoice'
								AND
								`recur_charges_fee_id` = '$recur_charges_fee_id'
...
?>
			  ...
			  <tr>
                ...
                <?php
				 ...
				 //echo @$itemline; 
						...
						$recur_charges_fee_type = $row_queryInvoice['fee_description8'];
						$recur_charges_fee_description = $row_queryInvoice['fee_description8'];
			...
			echo 	$check_8_sql = "SELECT * FROM `idsids_idsdms`.`ids_chargestorecurring`
							WHERE
								`ids_chargestorecurring`.`recur_charges_invoice_id` = '$colname_queryInvoice'
								AND
								`recur_charges_fee_id` = '$recur_charges_fee_id'
...
?>
			  ...
			  <tr>
                ...
                <?php
				 ...
				 //echo @$itemline; 
						...
						$recur_charges_fee_type = $row_queryInvoice['fee_description9'];
						$recur_charges_fee_description = $row_queryInvoice['fee_description9'];
			...
			echo 	$check_9_sql = "SELECT * FROM `idsids_idsdms`.`ids_chargestorecurring`
							WHERE
								`ids_chargestorecurring`.`recur_charges_invoice_id` = '$colname_queryInvoice'
								AND
								`recur_charges_fee_id` = '$recur_charges_fee_id'
...
?>
			  ...
			  <tr>
                ...
                <?php
				 ...
				 //echo @$itemline; 
						...
						$recur_charges_fee_type = $row_queryInvoice['fee_description10'];
						$recur_charges_fee_description = $row_queryInvoice['fee_description10'];
			...
			echo 	$check_10_sql = "SELECT * FROM `idsids_idsdms`.`ids_chargestorecurring`
							WHERE
								`ids_chargestorecurring`.`recur_charges_invoice_id` = '$colname_queryInvoice'
								AND
								`recur_charges_fee_id` = '$recur_charges_fee_id'
...
?>
			  ...
			  <tr>
                ...
                <?php
				 ...
				 //echo @$itemline; 
						...
						$recur_charges_fee_type = $row_queryInvoice['fee_description11'];
						$recur_charges_fee_description = $row_queryInvoice['fee_description11'];
			...
			echo 	$check_11_sql = "SELECT * FROM `idsids_idsdms`.`ids_chargestorecurring`
							WHERE
								`ids_chargestorecurring`.`recur_charges_invoice_id` = '$colname_queryInvoice'
								AND
								`recur_charges_fee_id` = '$recur_charges_fee_id'
...
?>
			  ...
			  <tr>
               ...
               <?php
				 ...
				 //echo @$itemline; 
						...
						$recur_charges_fee_type = $row_queryInvoice['fee_description12'];
						$recur_charges_fee_description = $row_queryInvoice['fee_description12'];
			...
			echo 	$check_12_sql = "SELECT * FROM `idsids_idsdms`.`ids_chargestorecurring`
							WHERE
								`ids_chargestorecurring`.`recur_charges_invoice_id` = '$colname_queryInvoice'
								AND
								`recur_charges_fee_id` = '$recur_charges_fee_id'
...
?>
			  ...
			  <tr>
                ...
                <?php
				 ...
				 //echo @$itemline; 
						...
						$recur_charges_fee_type = $row_queryInvoice['fee_description13'];
						$recur_charges_fee_description = $row_queryInvoice['fee_description13'];
			...
			echo 	$check_13_sql = "SELECT * FROM `idsids_idsdms`.`ids_chargestorecurring`
							WHERE
								`ids_chargestorecurring`.`recur_charges_invoice_id` = '$colname_queryInvoice'
								AND
								`recur_charges_fee_id` = '$recur_charges_fee_id'
...
?>
			  ...
			  <tr>
                ...
                <?php
				 ...
				 //echo @$itemline; 
						...
						$recur_charges_fee_type = $row_queryInvoice['fee_description14'];
						$recur_charges_fee_description = $row_queryInvoice['fee_description14'];
			...
			echo 	$check_14_sql = "SELECT * FROM `idsids_idsdms`.`ids_chargestorecurring`
							WHERE
								`ids_chargestorecurring`.`recur_charges_invoice_id` = '$colname_queryInvoice'
								AND
								`recur_charges_fee_id` = '$recur_charges_fee_id'
...
?>
			...
			<?php
						...
						$recur_charges_fee_type = $row_queryInvoice['fee_description15'];
						$recur_charges_fee_description = $row_queryInvoice['fee_description15'];
			...
			echo 	$check_15_sql = "SELECT * FROM `idsids_idsdms`.`ids_toinvoices_recurring`
							WHERE
								`ids_toinvoices_recurring`.`invoice_id` = '$colname_queryInvoice'
