...
if (!$_FILES) exit();
 	...
 	$this_prospctdlrid = mysqli_real_escape_string($idsconnection_mysqli, trim($_POST['prospctdlrid']));
 	$this_vehicleid = mysqli_real_escape_string($idsconnection_mysqli, trim($_POST['vehicleid']));



	// Make wefinancehere folder #2
	if (!file_exists("../vehicles/photos/2")) {
		mkdir("../vehicles/photos/2", 0777, true);
	}


	// Make wefinancehere folder #2
	if (!file_exists("../vehicles/photos/2/$this_vehicleid")) {
		mkdir("../vehicles/photos/2/$this_vehicleid", 0777, true);
	}
	
	// Make Dudes Media Folder
	if (!file_exists("../vehicles/photos/2/$this_vehicleid/thumbs")) {
		mkdir("../vehicles/photos/2/$this_vehicleid/thumbs", 0777, true);
	}
	...
	$photo_file_path = "../vehicles/photos/2/$this_vehicleid/$fileupload";
	
	$photo_thumb_fpath = "../vehicles/photos/2/$this_vehicleid/thumbs/$fileupload";
...
$totalRows_find_vehicle_photos = $count_files;
}
	...
	$upload_dudes_photos_sql = "INSERT INTO `idsids_idsdms`.`vehicle_photos` SET
								...
								`dealer_id` = '2',
								`prospctdlrid` = '$this_prospctdlrid',
