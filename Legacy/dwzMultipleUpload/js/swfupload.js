...
//dwzone
SWFUpload.prototype.getAllFiles = function () {
	var listFiles = new Array()
	var index = 0
	var file
	while(this.callFlash("GetFileByIndex", [index])){
		file = this.callFlash("GetFileByIndex", [index])
...
SWFUpload.prototype.getFileByDwzone = function (fileId) {
	var file
	var index = 0
	while(this.callFlash("GetFileByIndex", [index])){
		if(this.callFlash("GetFileByIndex", [index]).id == fileId){
			file = this.callFlash("GetFileByIndex", [index])
			break;
		}
		index ++;
...
SWFUpload.prototype.getAllQueueFiles = function () {
	var listFiles = new Array()
	var index = 0
	while(this.callFlash("GetFileByQueueIndex", [index])){
		listFiles.push(this.callFlash("GetFileByQueueIndex", [index]))
		index ++;
	}
	return listFiles;	
};
