...
//$query_cfs_exportquery = "SELECT * FROM vehicles WHERE did = '60' AND vehicles.vlivestatus = '1'";
...
//mysqli_data_seek($cfs_exportquery, 0);
 
while ($row = mysql_fetch_array($cfs_exportquery)) {
for ($i = 0; $i < $totalRows_cfs_exportquery; $i++) {
$output .='"'.$row["$i"].'",';
}
$output .="\n";
