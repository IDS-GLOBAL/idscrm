...
$query_select_centralauto = "SELECT * FROM dealers WHERE id = 60";
$select_centralauto = mysqli_query($idsconnection_mysqli, $query_select_centralauto);
$row_select_centralauto = mysqli_fetch_assoc($select_centralauto);
$totalRows_select_centralauto = mysqli_num_rows($select_centralauto);

mysqli_select_db($idsconnection_mysqli, $database_idsconnection);
$query_slct_vehicles = "SELECT * FROM vehicles WHERE vid = 60";
...
$did = $row_select_centralauto['id'];
$frazerid = $row_select_centralauto['feedidfrazer'];
$filename = $frazerid.'/FRZDATA3.CSV';

	if (file_exists($filename)) {
	
		echo $filename.'Your In Luck The File Exist';
...
$dwzCsvImport_1->SetFilePath("$filename");
...
$dwzCsvImport_1->SetCsvUniqueKey("5");
$dwzCsvImport_1->SetFieldSeparator(",");
$dwzCsvImport_1->SetSkipFirstLine("false");
$dwzCsvImport_1->SetEncloseField("DA");
$dwzCsvImport_1->AddItem("did", "Entered", "Ni", "$did", "None");
$dwzCsvImport_1->AddItem("frazerid", "Entered", "S", "$frazerid", "None");
$dwzCsvImport_1->AddItem("vlivestatus", "Entered", "Ni", "2", "None");
$dwzCsvImport_1->AddItem("vsource_idscrm_import_txt", "Entered", "S", "Frazer ImportCustomManual", "None");
$dwzCsvImport_1->AddItem("vyear", "Csv", "S", "", "2");
$dwzCsvImport_1->AddItem("vmake", "Csv", "S", "", "3");
$dwzCsvImport_1->AddItem("vmodel", "Csv", "S", "", "4");
$dwzCsvImport_1->AddItem("vvin", "Csv", "S", "", "5");
$dwzCsvImport_1->AddItem("vcondition", "Csv", "S", "", "7");
$dwzCsvImport_1->AddItem("vstockno", "Csv", "S", "", "1");
$dwzCsvImport_1->AddItem("vmileage", "Csv", "S", "", "6");
$dwzCsvImport_1->AddItem("vrprice", "Csv", "S", "", "11");
$dwzCsvImport_1->AddItem("vdprice", "Csv", "S", "", "17");
$dwzCsvImport_1->AddItem("vspecialprice", "Csv", "S", "", "12");
$dwzCsvImport_1->AddItem("vecolor_txt", "Csv", "S", "", "9");
$dwzCsvImport_1->AddItem("vbody", "Csv", "S", "", "14");
$dwzCsvImport_1->AddItem("vtransm", "Csv", "S", "", "16");
$dwzCsvImport_1->AddItem("vengine", "Csv", "S", "", "15");
$dwzCsvImport_1->AddItem("vcomments", "Csv", "S", "", "19");
$dwzCsvImport_1->AddItem("created_at", "Entered", "S", "NOW()", "None");
...
<title>Central Auto Import Script</title>
</head>
...
<?php
mysqli_free_result($select_centralauto);
