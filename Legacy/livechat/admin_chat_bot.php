...
for($k=0;$k<count($alltabs);$k++){
 ...
 if($channel_b['onchannel'] == $channel_a['onchannel']){
 	 ...
 	 ?>
 	 <td bgcolor="#<?php echo $txtcolor; ?>" align="center" nowrap="nowrap" class="tab"><a href="admin_chat_bot.php?channelsplit=<?php echo $channel_a['onchannel']; ?>__<?php echo $channel_a['userid']; ?>"><font color=<?php echo $usercolor; ?>> <b> <?php echo str_replace(" ","&nbsp;",$dakineuser); ?></b></font> </a>&nbsp;&nbsp;</td>
