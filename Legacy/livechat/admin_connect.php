...
function security(){
    ...
    url = '<?php print "http://idscrm.com/livechat/updates.php"; ?>'
    window.open(url,'rdfdsf','toolbar=yes,location=yes,directories=yes,status=yes,menubar=yes,scrollbars=yes,resizable=yes');
}  
 var sleeping=true; 
 </SCRIPT>
<?php }
// background=\"images/leftbk2.png\"
 print "<div class='row'>";
 print "<div class='col-md-9 col-sm-6'>";
 print "<div class='chat-discussion'>";
  print "<link  rel='stylesheet' href='style.css' type='text/css'>";
 print "<SCRIPT type=\"text/javascript\"> var sleeping=true; </SCRIPT><body id='big_chat' bgcolor=\"#fff\"><br><br><br><br><br><center>" . $lang['noone_online2'] . "</center>";
