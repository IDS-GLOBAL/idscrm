...
if($installed==true){
 ...
 $server = 'localhost';
 $database = 'idsids_idschat';
 $datausername = 'idsids_faith';
 $password = 'benjamin2831';
 ...
 $application_root = '/home4/idsids/public_html/livechat/';
 ...
 $API_HOME_DIR = '/home4/idsids/public_html/livechat/' . 'txt-db-api/';
