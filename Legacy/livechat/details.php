...
print "<b>User Agent :</b>" . $b->Agent  ."<br>"; // STRING - USER_AGENT_STRING
print "<b>Browser :</b>" . $b->Name  ."<br>"; // STRING - USER_AGENT_STRING
print "<b>Browser_Version :</b>". $b->Version   ."<br>"; // STRING - USER_AGENT_STRING 
