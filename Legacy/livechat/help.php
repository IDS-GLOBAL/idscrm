...
<tr><td bgcolor=<?php echo $color_alt1;?> > <img src=images/blank.gif width=22 height=21 name=one5><a href=http://www.craftysyntax.com/qa.php?d=<?php echo $CSLH_Config['directoryid'] ?>>General Questions & Answers</a></td></tr>
...
<tr><td bgcolor=<?php echo $color_alt1;?> > <img src=images/blank.gif width=22 height=21 name=i2v><a href="http://www.craftysyntax.com/features.php?d=<?php echo $CSLH_Config['directoryid'] ?>" target=_blank>Feature Requests!</a></td></tr>
<tr><td bgcolor=<?php echo $color_alt3;?> > <img src=images/blank.gif width=22 height=21 name=i2v><a href="http://www.craftysyntax.com/unbranded.php?d=<?php echo $CSLH_Config['directoryid'] ?>" target=_blank>Remove Powered By links </a></td></tr>
<tr><td bgcolor=<?php echo $color_alt3;?> > <img src=images/blank.gif width=22 height=21 name=i2v><a href="http://www.craftysyntax.com/members/?d=<?php echo $CSLH_Config['directoryid'] ?>" target=_blank>Member Services </a></td></tr>
