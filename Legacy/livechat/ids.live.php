...
<frameset rows="52,*,155" border="0" frameborder="0" framespacing="0" spacing="0" NORESIZE=NORESIZE>
         ...
         <frame src="http://idscrm.com/livechat/admin_options.php?tab=live" name="topofit" scrolling="no" border="0" marginheight="0" marginwidth="0" NORESIZE=NORESIZE>
         <frameset cols="*,317" border="0" frameborder="0" framespacing="0" spacing="0" NORESIZE=NORESIZE>
          <frameset rows="32,*" border="0" frameborder="0" framespacing="0" spacing="0" NORESIZE=NORESIZE>
           <frame src="http://idscrm.com/livechat/admin_rooms.php" name="rooms" scrolling="NO" border="0" marginheight="0" marginwidth="0" NORESIZE=NORESIZE>
           <frame src="http://idscrm.com/livechat/admin_connect.php?rand=<?php echo date("YmdHis"); ?>" name="connection" scrolling="AUTO" border="0" marginheight="0" marginwidth="0" NORESIZE=NORESIZE>
          </frameset>
          <frame src="http://idscrm.com/livechat/admin_users.php" name="users" scrolling="AUTO" border="0" marginheight="0" marginwidth="0" NORESIZE=NORESIZE>
         </frameset>
         <frame src="http://idscrm.com/livechat/admin_chat_bot.php" name="bottomof" scrolling="AUTO" border="0" marginheight="0" marginwidth="0" NORESIZE=NORESIZE>
        </frameset>
        <noframes></noframes>
