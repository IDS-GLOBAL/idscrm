<?php
//       LANGUAGE : English
//  TRANSLATION BY: livehelp@craftysyntax.com
...
$lang['txt81'] = "The name of the tab is what appears on the pop-up window for the user. This should  be something short like \"Live Chat\" or \"Message Board\" or \"Contact\"";
...
$lang['online_image'] = "When an operator is logged in to the Live Chat tab of the admin this will be the icon that will be shown wherever the live help HTML code is located. This is a url to the image relative to the livehelp directory. So for example if the folder you installed live help at is  at http://www.yourdomain.com/livehelp/myimage.gif you can enter in <b>myimage.gif</b>";
$lang['offline_image'] = "When an operator is not logged in to the Live Chat and Q&A is disabled then this is the image that will be shown wherever the live help HTML code is located. This is a url to the image relative to the livehelp directory. So for example if the folder you installed live help at is  at http://www.yourdomain.com/livehelp/myimage.gif you can enter in <b>myimage.gif</b>";
$lang['qa_image'] = "When an operator is not logged in to the Live Chat tab and q&A is enabled then this will be the icon that will be shown wherever the live help HTML code is located. This is a url to the image relative to the livehelp directory. So for example if the folder you installed live help at is  at http://www.yourdomain.com/livehelp/myimage.gif you can enter in <b>myimage.gif</b>";
...
$lang['credit'] = "This is the Publicly shown credit link back to Crafty Syntax Live Chat. This link is REQUIRED unless you have bought the ONE TIME unbranded Server licence <a href=http://www.craftysyntax.com/unbranded.php>which you can aquire HERE</a>. ";
...
$lang['how_to_add0'] = "<b>Option 2: Changing Image: </b> if you want to provide a Live Chat in an E-mail this is the best option.";
