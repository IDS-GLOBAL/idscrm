...
<?php } ?>
 		...
 		<?php if($usetable=="Y"){ ?>
 	   var newHTML =  '<table cellpadding=0 cellspacing=0 border=0><tr><td valign=top align=center><a id="chatRef" name="chatRef" href="javascript:openLiveHelp(<?php echo intval($UNTRUSTED['department']); ?>)" onclick="javascript:csTimeout_<?php echo $department; ?>=0;"><img name="csIcon" src="' + urltohelpimage_<?php echo $department; ?> + '" alt="Live Help" border="0"></a></td></tr>';
 
 	   newHTML = newHTML + '</table>';
 	   
    <?php } else { ?>
 	    var newHTML =  '<a id="chatRef" name="chatRef" href="javascript:openLiveHelp(<?php echo intval($UNTRUSTED['department']); ?>)" onclick="javascript:csTimeout_<?php echo $department; ?>=0;"><img name="csIcon" src="' + urltohelpimage_<?php echo $department; ?> + '" alt="Live Help" border="0"></a>';
...
function openLiveHelp(department)
{
  ...
  <?php if ($identity['COOKIE_SET'] == "Y") { ?>	
    window.open(WEBPATH + 'livehelp.php?department=' + department + '&website=<?php echo intval($UNTRUSTED['website']); ?>&cslhVISITOR=<?php echo $identity['SESSIONID']; ?><?php echo $querystringadd; ?>', 'chat54050872', 'width=<?php echo $winwidth; ?>,height=<?php echo $winheight; ?>,directories=no,titlebar=no,toolbar=no,location=no,status=no,menubar=no,scrollbars=1,resizable=1');
  <?php } else { ?>
    window.open(WEBPATH + 'livehelp.php?department=' + department + '&website=<?php echo intval($UNTRUSTED['website']); ?>&<?php echo $querystringadd; ?>', 'chat54050872', 'width=<?php echo $winwidth; ?>,height=<?php echo $winheight; ?>,directories=no,titlebar=no,toolbar=no,location=no,status=no,menubar=no,scrollbars=1,resizable=1');
  <?php } ?>
}
...
<?php
 ...
 ?>   
  ...
  // open the window.. 
  window.open(WEBPATH + 'livehelp.php?what=chatinsession&department=<?php echo intval($UNTRUSTED['department']); ?>&website=<?php echo intval($UNTRUSTED['website']); ?>&cslhVISITOR=<?php echo $identity['SESSIONID']; ?><?php echo $querystringadd; ?>', 'chat54050872', 'width=<?php echo $winwidth; ?>,height=<?php echo $winheight; ?>,directories=no,titlebar=no,toolbar=no,location=no,status=no,menubar=no,scrollbars=1,resizable=1');
}
