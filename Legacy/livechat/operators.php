...
<table id="big_tbl_operators" border=0>
...
<br><table id="table_operators" width=600><tr><td>
...
<tr><td colspan=2>
  ...
  <a href=http://www.craftysyntax.com/sounds.php?d=<?php echo $CSLH_Config['directoryid'] ?> target=_blank>DOWNLOAD MORE WAV SOUND FILES</a><br>
...
$count = 0;
	...
	while($file=readdir($handle)){
		...
		if(is_file("$dir/$file"))
    	   ...
    	   //document.operatorform.sound<?php print $count; ?>.Play();  	
