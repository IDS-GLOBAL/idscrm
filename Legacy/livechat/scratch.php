...
<?php
   ...
   if($_SERVER['HTTPS'] == "on") {
    //print "<img src=https://www.craftysyntax.com/security/?p=scratch&randu=".date("YmdHis")."&format=image&v=". $CSLH_Config['version'] . "&d=". $CSLH_Config['directoryid'] . "&h=" . $_SERVER['HTTP_HOST'] . "  name=security id=security width=1 height=1 border=0></a><br>";
  } else {
     //print "<img src=http://security.craftysyntax.com/?p=scratch&randu=".date("YmdHis")."&format=image&v=". $CSLH_Config['version'] . "&d=". $CSLH_Config['directoryid'] . "&h=" . $_SERVER['HTTP_HOST'] . "  name=security id=security  width=1 height=1  border=0></a><br>";
  }
 } else { print "<body>"; }
?>
<br>
...
<DIV id=updatestuff  STYLE="display:none;">
  <?php
       $url = "http://www.craftysyntax.com/remote_scratch.php?v=" . $CSLH_Config['version'] . "&d=" . $CSLH_Config['directoryid'] . "&m=" . $CSLH_Config['membernum'] . "&h=" . $_SERVER['HTTP_HOST'];          
       print "<iframe src=$url width=550 height=250 scroll=AUTO border=0></iframe>";
   ?><br><br>
</DIV>
