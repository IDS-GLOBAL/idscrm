...
$query_wfh_approvals = "SELECT * FROM `idsids_wefinancehere`.`wfhuser_approvals` ORDER BY `wfhuser_approvals`.`wfhuser_approval_id` DESC";
$wfh_approvals = mysqli_query($wfh_connection_mysqli, $query_wfh_approvals);
$row_wfh_approvals = mysqli_fetch_array($wfh_approvals);
$totalRows_wfh_approvals = mysqli_num_rows($wfh_approvals);


mysqli_select_db($wfh_connection_mysqli, $database_wfh_connection);
$query_wfh_approvaldeals = "SELECT * 
FROM `idsids_wefinancehere`.`wfhuser_approvals_perms`, `wfhuser_approvals` 
WHERE `wfhuser_approvals_perms`.`wfhuserperm_approval_id` = `wfhuser_approvals`.`wfhuser_approval_id` 
ORDER BY `wfhuser_approvals_perms`.`wfhuserperm_created_at` DESC";
...
<?php include("analyticstracking.php"); ?>
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="cardeals.php">Car Deals</a>
                    </li>
                </ol>
            </div>
            <div class="col-lg-2">
              ...
              <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Quick Approvals Ledger <small>Sort, search</small></h5>
                    </div>
 ...
 <table class="table table-striped table-bordered table-hover dataTables-example" >
            ...
            <tr class="gradeX">
                    ...
                    <td><span title="<?php echo $row_wfh_approvals['cust_creditapr_txt']; ?>">
						<?php echo $row_wfh_approvals['wfhuser_approval_apr']; ?></span>
                    </td>
                    <td><?php echo $row_wfh_approvals['wfhuser_approval_market']; ?></td>
                    <td><?php echo $row_wfh_approvals['wfhuser_approval_state']; ?></td>
                    <td><?php echo $row_wfh_approvals['wfhuser_approval_dwpymt'];  ?></td>
                    <td><?php echo $row_wfh_approvals['wfhuser_approval_ip']; ?></td>
                    <td><?php echo $row_wfh_approvals['wfhuser_approval_created_at']; ?></td>
            </tr>
                                      <?php } while ($row_wfh_approvals = mysqli_fetch_array($wfh_approvals)); ?>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5><?php echo $totalRows_wfh_approvaldeals; ?> WFH Approvals <small>Sort, search</small></h5>
                    </div>
                    <div class="ibox-content">
...
<div class="row">
                    <?php do{ ?>
                 <div class="col-sm-4">   
                    <?php echo $row_wfh_approvaldeals['wfhuserperm_approval_id']; ?> On <?php echo $row_wfh_approvaldeals['wfhuserperm_created_at']; ?> | <?php echo $row_wfh_approvaldeals['wfhuserperm_ourrank']; ?> | <?php echo $row_wfh_approvaldeals['wfhuserperm_ip']; ?> | <?php echo $row_wfh_approvaldeals['wfhuserperm_when_date']; ?> <br />
                 </div>   
