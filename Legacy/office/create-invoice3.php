...
$mylimit=1;  // Maximum number value to be set here


?>
<?php
$itemline = "<table width='100%' border='0' cellpadding='0' cellspacing='0' class='gwlines'>
			  <tr>
				<td><input type='text' name='fee_description' id='fee_description' value='' /></td>
...
echo "xmlhttp.open('GET','ajaxEnviro/ajax_getlineitem.php?fee_id='+str,true);";
...
?>
                ...
                <div id="lineitem1">
<input type="text" name="fee_description" id="fee_description" />                  <input name="quantity" type="text" id="quantity" size="5" />                  <input name="fee_price" type="text" id="fee_price" size="10" />                  <input name="fee_amount" type="text" id="fee_amount" size="10" />                  <input <?php if (!(strcmp("$myfeetaxed","1"))) {echo "checked=\"checked\"";} ?> name="utc1" type="checkbox" class="utc" id="utc2" />
				</div>
