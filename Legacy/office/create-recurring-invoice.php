...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "invoiceBody")) {
  $insertSQL =  sprintf("INSERT INTO ids_toinvoices_recurring (invoice_typeid, invoice_number, invoice_tokenid, invoice_dealerid, invoice_status, invoice_date, invoice_duedate, invc_cret_evry, invc_cret_evrywhn, invoice_recurring_stopdate, daysto_payinvoice, invoice_autocharge, invoice_latefee, invoice_sendtoclient, invoice_currency, fee_id1, lineitem1, fee_description1, quantity1, fee_price1, fee_amount1, tax1, fee_id2, lineitem2, fee_description2, quantity2, fee_price2, fee_amount2, tax2, fee_id3, lineitem3, fee_description3, quantity3, fee_price3, fee_amount3, tax3, fee_id4, lineitem4, fee_description4, quantity4, fee_price4, fee_amount4, tax4, fee_id5, lineitem5, fee_description5, quantity5, fee_price5, fee_amount5, tax5, fee_id6, lineitem6, fee_description6, quantity6, fee_price6, fee_amount6, tax6, fee_id7, lineitem7, fee_description7, quantity7, fee_price7, fee_amount7, tax7, fee_id8, lineitem8, fee_description8, quantity8, fee_price8, fee_amount8, tax8, fee_id9, lineitem9, fee_description9, quantity9, fee_price9, fee_amount9, tax9, fee_id10, lineitem10, fee_description10, quantity10, fee_price10, fee_amount10, tax10, fee_id11, lineitem11, fee_description11, quantity11, fee_price11, fee_amount11, tax11, fee_id12, lineitem12, fee_description12, quantity12, fee_price12, fee_amount12, tax12, fee_id13, lineitem13, fee_description13, quantity13, fee_price13, fee_amount13, tax13, fee_id14, lineitem14, fee_description14, quantity14, fee_price14, fee_amount14, tax14, fee_id15, lineitem15, fee_description15, quantity15, fee_price15, fee_amount15, tax15, sales_taxrate, invoice_subtotal, invoice_taxtotal, invoice_total, applied_payment, invoice_amount_due, invoice_harddatetime) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['invc_cret_evry'], "text"),
                       GetSQLValueString($_POST['invc_cret_evrywhn'], "text"),
                       GetSQLValueString($_POST['invoice_recurring_stopdate'], "text"),
                       GetSQLValueString($_POST['daysto_payinvoice'], "int"),
                       GetSQLValueString(isset($_POST['invoice_autocharge']) ? "true" : "", "defined","'Y'","'N'"),
                       GetSQLValueString($_POST['invoice_latefee'], "text"),
                       ...
                       GetSQLValueString($_POST['invoice_harddatetime'], "text"));

  mysqli_select_db($idsconnection_mysqli, $database_idsconnection);
  $Result1 = mysqli_query($idsconnection_mysqli, $insertSQL);

  $insertGoTo = "script_invoices_recurring.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysqli_select_db($idsconnection_mysqli, $database_idsconnection);
$query_selectDealer = "SELECT `id`, `company`, `website`, `status` FROM `idsids_idsdms`.`dealers` ORDER BY `dealers`.`company` ASC";
...
mysqli_select_db($idsconnection_mysqli, $database_idsconnection);
$query_lastInvcNum = "SELECT * FROM `idsids_idsdms`.`ids_toinvoices` WHERE `ids_toinvoices`.`invoice_dealerid` = '$did' ORDER BY `ids_toinvoices`.`invoice_number` ASC";
...
<title>Billing | Create Recurring Invoice</title>
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="invoiceBody" id="invoiceBody" >
  ...
  <div class="gadget">
    <div class="gadget_title gradient37 vertsortable_head">
      <a href="#" class="hidegadget" rel="hide_block"><img src="images/spacer.gif" alt="picture" width="19" height="33" /></a>
      <h3>Recurring Invoice Create Details - This Invoice will Create A Continous Basis From The Settings Here.</h3>
      </div>
    <div class="gadget_content">
      <div class="subblock">
        ...
        <table width="100%" border="0" cellspacing="3" cellpadding="3" class="gwlines">
                  <tr>
                    ...
                    <th><input name="invoice_number" type="text" value="<?php echo $lastinvoiceno; ?>" />
                    <input name="invoice_sendtoclient" type="hidden" id="invoice_sendtoclient" value="Y" /> 
                ...
                <input name="invoice_typeid" type="hidden" id="invoice_typeid" value="1" />
                  ...
                  <tr>
                    ...
                    <th><input name="invoice_date" type="text" id="datepicker" value="<?php echo $nowdate; ?>" /></th>
                  </tr>
                  <tr>
                    <th>Status</th>
                  ...
                  <tr>
                    ...
                    <th><input name="invoice_duedate" id="datepicker2" type="text" /> 
                      <a href="#">Calendar</a></th>
                  </tr>
                  <tr>
                    <th>After That Create A New Invoice Every:</th>
                    <th><input name="invc_cret_evry" type="text" id="invc_cret_evry" size="4" />
                  ...
                  <tr>
                    ...
                    <th><input type="text" name="invoice_recurring_stopdate" id="datepicker3" />
                      <a href="#">Calendar</a></th>
                  </tr>
                  <tr>
                    <th>Days To Pay Each Invoice</th>
                    <th><input name="daysto_payinvoice" type="text" id="daysto_payinvoice" value="10" size="5" /></th>
                  </tr>
                  <tr>
                    <th>Automatically Charge?</th>
                    <th><input name="invoice_autocharge" type="checkbox" id="invoice_autocharge" value="Y" /></th>
                  </tr>

				<tr>
                    <th>Late Fee? (After Invoice Is Late)</th>
                    <th><input name="invoice_latefee" type="text" id="invoice_latefee" value="" size="5" /></th>
				</tr>
...
<!-- gadget right 5 -->
  ...
  <tr>
    ...
    <input name="invoice_harddatetime" type="hidden" id="invoice_harddatetime" value="<?php echo $timevar; ?>" />
    </td>
  </tr>
</table>
