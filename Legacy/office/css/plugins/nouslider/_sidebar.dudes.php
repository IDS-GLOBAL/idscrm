                    ...
                    <li class="nav-header">
                        ...
                        <div class="dropdown profile-element"> <span>
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                ...
                                <li><a ice:repeating="ids_accountsettings_link" href="account.php">Settings</a></li>
                                <li class="divider"></li>
...
<?php if($dudes_skillset_id == '9'){ ?>
                    ...
                    <li>
                        <a href="power.php"><i class="fa fa-th-large"></i> <span class="nav-label">Power</span> <span class="fa arrow"></span></a>
...
<?php }?>
                    ...
                    <li>
                        <a role="button"><i class="fa fa-envelope"></i> <span class="nav-label">Script Templates </span><span class="label label-warning pull-right"><?php echo $totalRows_dealer_template_types_inactive; ?>/<?php echo $totalRows_dealer_template_types; ?></span></a>
                        <ul class="nav nav-second-level">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a href="#">Pending Deals</a></li>
                             <li><a href="#">Completed Deals</a></li>
                        </ul>
                    </li>
...
<?php if($dudes_skillset_id == '9'){ ?>
                        	<li><a href="billing.php">Old Billing</a></li>
<?php }?>                            
                    ...
                    <li class="special_link">
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li><a href="ticketi.create.php">Create A Internal Trouble Ticket</a></li>
                             <li><a href="ticketd.history.php">View Internal Trouble Ticket(s)</a></li>
