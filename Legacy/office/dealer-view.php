...
mysqli_select_db($idsconnection_mysqli, $database_idsconnection);
$query_dealers = "SELECT * FROM dealers ORDER BY company ASC";
...
<table width="900" border="0" align="center" cellpadding="0" cellspacing="0" id="dataTable">
	...
	<!--Loop start, you could use a repeat region here-->
		<?php do { ?>
		  <tr>
		    <td><a href="dealer-view-update.php?dealer=<?php echo $row_dealers['id']; ?>"><?php echo $row_dealers['id']; ?></a></td>
		    <td><a href="dealer-view-update.php?dealer=<?php echo $row_dealers['id']; ?>">
				<?php 
		    ...
		    <td><a href="dealer-view-update.php?dealer=<?php echo $row_dealers['id']; ?>"><?php echo $row_dealers['company']; ?></a></td>
		    <td><a href="dealer-view-update.php?dealer=<?php echo $row_dealers['id']; ?>"><?php echo $row_dealers['city']; ?></a></td>
		    <td><a href="dealer-view-update.php?dealer=<?php echo $row_dealers['id']; ?>"><?php echo $row_dealers['state']; ?></a></td>
		    <td><a href="dealer-view-update.php?dealer=<?php echo $row_dealers['id']; ?>"><?php echo $row_dealers['zip']; ?></a></td>
		    <td>
            	<a href="http://<?php echo $row_dealers['website']; ?>" target="_blank">
					<?php echo $row_dealers['website']; ?>
            	</a>
            </td>
		    
		    <td><a href="dealer-view-update.php?dealer=<?php echo $row_dealers['id']; ?>"><?php echo $row_dealers['email']; ?></a></td>
		    <td><a href="dealer-view-update.php?dealer=<?php echo $row_dealers['id']; ?>"><?php echo $row_dealers['phone']; ?></a></td>
		    <td>
            	<a href="dealer-view-update.php?dealer=<?php echo $row_dealers['id']; ?>" target="_blank">
