/*
Last Modified: 03/08/06 12:31:09
...
////
  ...
  hasParent: function(elm, parent_to_concider, max_look_up) {
    if(elm == parent_to_concider)
      return true;
    if(max_look_up == 0)
      return false;
    return hasParent(elm.parentNode, parent_to_concider, max_look_up-1);
  },
...
////
  //Shortcut: AJS.DI
  documentInsert: function(node) {
    document.writeln('<span id="dummy_holder"></span>');
    this.swapDOM(this.$('dummy_holder'), node);
  },
  ...
  UL: function() {return this._createDOM("ul", arguments);},
  LI: function() {return this._createDOM("li", arguments);},
  TD: function() {return this._createDOM("td", arguments);},
  TR: function() {return this._createDOM("tr", arguments);},
  TH: function() {return this._createDOM("th", arguments);},
  TBODY: function() {return this._createDOM("tbody", arguments);},
  TABLE: function() {return this._createDOM("table", arguments);},
  INPUT: function() {return this._createDOM("input", arguments);},
  SPAN: function() {return this._createDOM("span", arguments);},
  B: function() {return this._createDOM("b", arguments);},
  A: function() {return this._createDOM("a", arguments);},
  DIV: function() {return this._createDOM("div", arguments);},
  IMG: function() {return this._createDOM("img", arguments);},
  BUTTON: function() {return this._createDOM("button", arguments);},
  H1: function() {return this._createDOM("h1", arguments);},
  H2: function() {return this._createDOM("h2", arguments);},
  H3: function() {return this._createDOM("h3", arguments);},
  BR: function() {return this._createDOM("br", arguments);},
  TEXTAREA: function() {return this._createDOM("textarea", arguments);},
  FORM: function() {return this._createDOM("form", arguments);},
  P: function() {return this._createDOM("p", arguments);},
  SELECT: function() {return this._createDOM("select", arguments);},
  OPTION: function() {return this._createDOM("option", arguments);},
  TN: function(text) { return document.createTextNode(text); },
  IFRAME: function() {return this._createDOM("iframe", arguments);},
  SCRIPT: function() {return this._createDOM("script", arguments);},
  CENTER: function() {return this._createDOM("center", arguments);},
  DL: function() {return this._createDOM("DL", arguments);},
  DT: function() {return this._createDOM("DT", arguments);},
  DD: function() {return this._createDOM("DD", arguments);},
  SMALL: function() {return this._createDOM("SMALL", arguments);},
