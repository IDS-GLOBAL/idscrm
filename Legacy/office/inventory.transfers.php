        ...
        <div class="wrapper wrapper-content animated fadeInRight"><!-- Start wrapper wrapper-content animated fadeInRight -->
              ...
              <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Incoming Transfers <small>Sort, search</small></h5>
                    </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Outgoing Transfers <small>Sort, search</small></h5>
                    </div>
                    <div class="ibox-content">
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Transfer Actions <small>Sort, search</small></h5>
                    </div>
                    <div class="ibox-content">
