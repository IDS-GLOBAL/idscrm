...
$query_queryInvoices = "
SELECT * 
FROM `idsids_idsdms`.`ids_toinvoices_recurring`, 
`idsids_idsdms`.`dealers` 
WHERE `ids_toinvoices_recurring`.`invoice_dealerid` = `dealers`.`id` 
ORDER BY `ids_toinvoices_recurring`.`invoice_status` ASC,`ids_toinvoices_recurring`.`invoice_id` DESC";
            ...
            <div class="subblock">
              ...
              <table width="100%" border="1" cellspacing="3" cellpadding="3">
                ...
                <?php do { ?>
                    ...
                    <tr>
                      <td><a href="update-recurring-invoice.php?invoice_id=<?php echo $row_queryInvoices['invoice_id']; ?>"><?php echo $row_queryInvoices['invoice_id']; ?></a></td>
                      <td title="<?php echo $row_queryInvoices['contact']; ?> or <?php echo $row_queryInvoices['dmcontact2']; ?>"><a href="update-recurring-invoice.php?invoice_id=<?php echo $row_queryInvoices['invoice_id']; ?>"><?php echo $row_queryInvoices['invoice_dealerid']; ?> - <?php echo $row_queryInvoices['company']; ?></a></td>
                      <td><a href="update-recurring-invoice.php?invoice_id=<?php echo $row_queryInvoices['invoice_id']; ?>"><?php echo $row_queryInvoices['invoice_status']; ?></a></td>
                      <td><a href="update-recurring-invoice.php?invoice_id=<?php echo $row_queryInvoices['invoice_id']; ?>"><?php echo $row_queryInvoices['invoice_date']; ?></a></td>
                      <td><a href="update-recurring-invoice.php?invoice_id=<?php echo $row_queryInvoices['invoice_id']; ?>"><?php echo $row_queryInvoices['invoice_duedate']; ?></a></td>
                      <td title="Creating Every <?php echo $row_queryInvoices['invc_cret_evry']; ?> <?php echo $row_queryInvoices['invc_cret_evrywhn']; ?> "><?php echo $row_queryInvoices['daysto_payinvoice']; ?> </td>
                      <td><?php echo $row_queryInvoices['invoice_amount_due']; ?></td>
                      <td><?php if(!$row_queryInvoices['invoice_recurring_stopdate']){echo 'None';}else{ echo $row_queryInvoices['invoice_recurring_stopdate'];} ?></td>
                      <td><a href="update-recurring-invoice.php?invoice_id=<?php echo $row_queryInvoices['invoice_id']; ?>"><img src="images/pimpa_no.gif" alt="picture" width="15" height="15" class="tabpimpa"></a></td>
                    </tr>
