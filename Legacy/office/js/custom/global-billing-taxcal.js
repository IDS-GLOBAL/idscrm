...
$(document).ready(function() {
    ...
    $(document).on('change', 'input#editLive_invoice_arrival_fee', function(event) {
        console.log('Changed Arrival Fee Amount');
    ...
    $(document).on('change', 'input#editLive_invoice_shippinghanding', function(event) {
        console.log('Changed Shipping Handling Amount');
        process_livetotal();
...
function run_editrecur_invoice_taxtotal() {
    ...
    $("div#update_reocurring_invoice_fees_box  input#recurEdit_fee_taxed:checked").each(function() {
        ...
        var recurEdit_fee_qty = parseInt($(this).parent().parent().parent().parent().parent().find('input#recurEdit_fee_qty').val());
        console.log('recurEdit_fee_qty: ' + recurEdit_fee_qty);
        var recurEdit_fee_total = parseFloat($(this).parent().parent().parent().parent().parent().find('input#recurEdit_fee_price').val());
        console.log('recurEdit_fee_total: ' + recurEdit_fee_total);

        var recurEdit_fee_amount = parseFloat($(this).parent().parent().parent().parent().parent().find('input#recurEdit_fee_amount').val());
...
function process_livetotal() {
	...
	console.log('editLive_invoice_arrival_fee: '+editLive_invoice_arrival_fee);


    var combine_Live_invoice_three_totals = (fee_taxtotal - 0) + (editLive_invoice_shippinghanding - 0) + (editLive_invoice_arrival_fee - 0);

	console.log('combine_Live_invoice_three_totals: '+combine_Live_invoice_three_totals);
    console.log('fee_taxtotal: ' + fee_taxtotal);
...
function run_editlive_invoice_amountduetotal() {
	...
	var editLive_invoice_arrival_fee = parseFloat($('input#editLive_invoice_arrival_fee').val());
	var editLive_invoice_shippinghanding = parseFloat($('input#editLive_invoice_shippinghanding').val());

    var editLive_applied_payment = parseFloat($('input#editLive_applied_payment').val());
	


    var combine_For_live_invoice_total = (editLive_invoice_taxtotal - 0) + (editLive_invoice_subtotal - 0) +  (editLive_invoice_arrival_fee - 0) +  (editLive_invoice_shippinghanding - 0);
	...
	console.log('combine_For_live_invoice_total: '+combine_For_live_invoice_total.toFixed(2));


    var combine_For_amount_due = (editLive_invoice_taxtotal - 0) + (combine_For_live_invoice_total - 0) - (editLive_applied_payment - 0);
...
function processUpdatedReoccuringFees() {
    ...
    $("div#update_reocurring_invoice_fees_box  input#recurEdit_fee_price").each(function() {
        ...
        var rec_fee_type = $(this).parent().parent().find('select#recurEdit_fee_type').val();
        console.log('rec_fee_type: ' + rec_fee_type);
        var rec_fee_type_txt = $(this).parent().parent().find('input#recurEdit_fee_description').val();
        console.log('rec_fee_type_txt: ' + rec_fee_type_txt);

        var recur_charges_fee_description = $(this).parent().parent().find('input#recurEdit_fee_description').val();
        var recur_charges_fee_qty = parseInt($(this).parent().parent().find('input#recurEdit_fee_qty').val());
        var recur_charges_fee_price = $(this).val();
        var recurEdit_fee_amount = $(this).parent().parent().find('input#recurEdit_fee_amount').val();
