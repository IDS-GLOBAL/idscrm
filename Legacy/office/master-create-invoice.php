...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "invoiceBody")) {
  ...
  $insertGoTo = "invoice-pending.php";
  if (isset($_SERVER['QUERY_STRING'])) {
    ...
    <div class="gadget_content">
      <div class="subblock">
        ...
        <table width="100%" border="0" cellspacing="3" cellpadding="3" class="gwlines">
          ...
          <tr>
            <th>Invoice Date:</th>
            <th><input name="invoice_date" id="datepicker" type="text" /> <a href="#">Calendar</a></th>
            </tr>
          <tr>
            <th>Due Date:</th>
            <th><input name="invoice_duedate" id="datepicker2" type="text" /> <a href="#">Calendar</a></th>
            </tr>
          <tr>
            <th>Status</th>
...
<!-- gadget right 5 -->
  ...
  <tr>
    ...
    <td><input type="submit" name="submit2" id="submit2" value="Submit" />
      <input name="invoice_harddatetime" type="hidden" id="invoice_harddatetime" value="<?php echo $timevar; ?>" /></td>
  </tr>
</table>
