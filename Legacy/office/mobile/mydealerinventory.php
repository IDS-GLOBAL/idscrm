...
mysqli_select_db($idsconnection_mysqli, $database_idsconnection);
$query_mydealerInventoryLive = "SELECT * FROM vehicles WHERE vlivestatus = '1' AND vehicles.did = '$did' ORDER BY vehicles.created_at DESC";
...
<div data-role="page">
				...
				<div data-role="content" data-theme="a">
					<ul data-role="listview" data-filter="true" data-inset="true">
                      ...
                      <?php
					  $vid = $row_mydealerInventoryLive['vid'];
					  $vdid = $row_mydealerInventoryLive['did'];
					  $vcondition = $row_mydealerInventoryLive['vcondition'];
					  $vyear = $row_mydealerInventoryLive['vyear'];
					  $vmake = $row_mydealerInventoryLive['vmake'];
					  $vmodel = $row_mydealerInventoryLive['vmodel'];
					  $vtrim = $row_mydealerInventoryLive['vtrim'];
					  $file = $row_mydealerInventoryLive['vthubmnail_file']; 
					  
					  
					$link = "http://images.autocitymag.com";
					//$photo = $row_slctVphotos['photo_file_name'];
				  	$dynamicImg = "$link/$vdid/$vid/$file";

					  ?>
			            <li data-theme="a">
			              <h3><?php echo "$vcondition | $vyear $vmake $vmodel $vtrim"; ?></h3>
			              <p>Stock Number: <?php echo $row_mydealerInventoryLive['vstockno']; ?> | Mileage: <?php echo $row_mydealerInventoryLive['vmileage']; ?> | <div id="thubmnail"><img src="<?php echo $dynamicImg; ?>" width="120px" /></div></p>
			              <ul data-theme="a">
			                <li>Edit This Vehicle
			                  <ul data-theme="a">
			                    <li><a href="index.html">
                                
                                	Click Here To Edit This Vehicle
                                    </a>
                                </li>
		                      </ul>
		                    </li>
			            ...
			            <?php } while ($row_mydealerInventoryLive = mysqli_fetch_array($mydealerInventoryLive)); ?>
