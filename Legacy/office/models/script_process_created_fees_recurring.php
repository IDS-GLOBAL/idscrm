...
$query_create_toinvoices_recurring = "
 INSERT INTO `idsids_idsdms`.`ids_chargestorecurring` SET 
    ...
    `recur_charges_source_id` = '$dudesid', 
    ...
    $new_recurring_ids_charges_torecurring_charge_id = mysqli_insert_id($idsconnection_mysqli);

    $dudes_dlr_body = "
    $myname $dudesid Created a new reccuring invoice line Charge #$new_recurring_ids_charges_torecurring_charge_id 
    ";
