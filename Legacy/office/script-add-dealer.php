...
mysqli_select_db($idsconnection_mysqli, $database_idsconnection);
$query_dealers_pend = "SELECT * FROM idsids_idsdms.dealers WHERE dealer_pending_id = '$id'";
...
$newdid = $row_dealers_pend['id'];
	...
	$inertDudeActivityStr = "INSERT INTO `idsids_tracking_idsvehicles`.`dudes_activity` (`dudes_dlr_actid`, `dudes_dlr_did`, `dudes_dlr_did_prospctid`, `dudes_dlr_dude_id`, `dudes_dlr_dude_name`, `dudes_dlr_body`, `dudes_dlr_created_at`) VALUES (NULL, 'NULL', '$id', '$dudesid', '$myname', 'Added System Dealer $newdid Into The System', CURRENT_TIMESTAMP)";
...
header("Location: dealer-view-update.php?dealer=$newdid");
?>
...
<body>
<?php echo $row_dealers_pend['id']; ?>
<?php echo $row_dealers_pend['company']; ?>
<?php echo $row_dealers_pend['website']; ?>
<?php echo $row_dealers_pend['email']; ?>
<?php echo $row_dealers_pend['username']; ?>
<?php echo $row_dealers_pend['password']; ?>
</body>
</html>
<?php
?>