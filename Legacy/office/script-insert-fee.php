...
<?php
	...
	$inertDudeActivityStr = "INSERT INTO `idsids_tracking_idsvehicles`.`dudes_activity` (`dudes_dlr_actid`, `dudes_dlr_did`, `dudes_dlr_did_prospctid`, `dudes_dlr_dude_id`, `dudes_dlr_dude_name`, `dudes_dlr_body`, `dudes_dlr_created_at`) VALUES (NULL, 'NULL', 'NULL', '$dudesid', '$myname', '$myname Added New Fee To Invoice System', CURRENT_TIMESTAMP)";
...
header("Location: create-fees.php");

echo 'This is the page after a fee record has been inserted';
