...
$id = $_GET['id'];
	...
	$id =  mysql_real_escape_string($idsconnection_mysqli, $_GET['dealer']);
	...
	$inertDudeActivityStr = "INSERT INTO `idsids_tracking_idsvehicles`.`dudes_activity` (`dudes_dlr_actid`, `dudes_dlr_did`, `dudes_dlr_did_prospctid`, `dudes_dlr_dude_id`, `dudes_dlr_dude_name`, `dudes_dlr_body`, `dudes_dlr_created_at`) VALUES (NULL, 'NULL', '$id', '$dudesid', '$myname', '$myname Added Inventory Into Dealer $id Information', CURRENT_TIMESTAMP)";
...
header("Location: add-inventory-duded.php?&id=$id&name=$name");
