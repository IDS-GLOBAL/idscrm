...
$dudes_workphone_router_brand = mysqli_real_escape_string($idsconnection_mysqli, trim($_POST['ddudes_workphone_router_brand']));
...
$dudes_hourlyrate = mysqli_real_escape_string($idsconnection_mysqli, trim($_POST['ddudes_hourlyrate']));
...
$dudes_state_deductions = mysqli_real_escape_string($idsconnection_mysqli, trim($_POST['ddudes_state_deductions']));

$dudes_jobposition_title_id = mysqli_real_escape_string($idsconnection_mysqli, trim($_POST['ddudes_jobposition_title_id']));
$dudes_jobposition_title_text = mysqli_real_escape_string($idsconnection_mysqli, trim($_POST['ddudes_jobposition_title_text']));

$dudes_taxexempt = mysqli_real_escape_string($idsconnection_mysqli, trim($_POST['ddudes_taxexempt']));
$internal_comments_super_admin = mysqli_real_escape_string($idsconnection_mysqli, trim($_POST['internal_comments_super_admin']));



$create_dude_sql = "
INSERT INTO `idsids_idsdms`.`dudes` SET
...
`dudes_workphone_ext` = '$dudes_workphone_ext',
...
`dudes_workphone_router_brand` = '$dudes_workphone_router_brand',
...
`dudes_lastmodified` = '$dudes_lastmodified',
...
`dudes_hourlyrate` = '$dudes_hourlyrate',
...
";
	...
	if(!$founddudes_secret_token){
	//echo $create_dude_sql;
	$run_create_dude_sql = mysqli_query($idsconnection_mysqli, $create_dude_sql);
