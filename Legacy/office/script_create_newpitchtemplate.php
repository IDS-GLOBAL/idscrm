...
if(isset($_POST['dudes_secret_token'], $_POST['dudes_cat_id'], $_POST['dudes_cat_label'], $_POST['pitch_systm_templates_subject'], $_POST['days_response'], $_POST['dudes_salespitch_body'], $_POST['pitch_systm_templates_status'])){
...
$dudes_salespitch_days_response = mysqli_real_escape_string($idsconnection_mysqli, trim($_POST['days_response']));
   ...
   echo $insertSQL = "INSERT INTO `idsids_tracking_idsvehicles`.`dudes_salespitch` SET
							`dudes_salespitch_token` = '$posted_token',
							...
							";
  $Result1 = mysqli_query($idsconnection_mysqli, $insertSQL, $tracking);
