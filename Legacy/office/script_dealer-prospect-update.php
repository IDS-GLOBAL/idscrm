...
<?php
	...
	$id =  mysqli_real_escape_string($tracking_mysqli, $_GET['dealer']);
	
	$state =  mysqli_real_escape_string($tracking_mysqli, $_GET['state']);
	...
	$inertDudeActivityStr = "INSERT INTO `idsids_tracking_idsvehicles`.`dudes_activity` (`dudes_dlr_actid`, `dudes_dlr_did`, `dudes_dlr_did_prospctid`, `dudes_dlr_dude_id`, `dudes_dlr_dude_name`, `dudes_dlr_body`, `dudes_dlr_created_at`) VALUES (NULL, 'NULL', '$id', '$dudesid', '$myname', 'Updated Prospect Dealer $id Information', CURRENT_TIMESTAMP)";
