...
<?php
	...
	$id =  mysqli_real_escape_string($idsconnection_mysqli, $_GET['dealer']);
	
	$state =  mysqli_real_escape_string($idsconnection_mysqli, $_GET['state']);
	...
	$insertDudeActivityStr = "INSERT INTO `idsids_tracking_idsvehicles`.`dudes_activity` (`dudes_dlr_actid`, `dudes_dlr_did`, `dudes_dlr_did_prospctid`, `dudes_dlr_dude_id`, `dudes_dlr_dude_name`, `dudes_dlr_body`, `dudes_dlr_created_at`) VALUES (NULL, 'NULL', '$id', '$dudesid', '$myname', 'Updated Dealer Information', CURRENT_TIMESTAMP)";
//$insertDudeActivityStr = mysql_real_escape_string($inertDudeActivityStr);
...
include("inc.end.phpmsyql.php");
	...
	header("Location: dealer-prospects.php?state=$state");
