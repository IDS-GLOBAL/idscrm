...
<?php
	...
	$inertDudeActivityStr = "INSERT INTO `idsids_tracking_idsvehicles`.`dudes_activity` (`dudes_dlr_actid`, `dudes_dlr_did`, `dudes_dlr_did_prospctid`, `dudes_dlr_dude_id`, `dudes_dlr_dude_name`, `dudes_dlr_body`, `dudes_dlr_created_at`) VALUES (NULL, 'NULL', 'NULL', '$dudesid', '$myname', '$myname Edited A Vehicle In The System', CURRENT_TIMESTAMP)";
...
//script-insert-fee.php


header("Location: dealer-view-update.php?dealer=$did");

echo 'This is the page after a record has been inserted for activity';
