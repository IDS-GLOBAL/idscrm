...
mysqli_select_db($idsconnection_mysqli, $database_idsconnection);
$query_query_payments = "SELECT * FROM ids_toinvoices, dealers WHERE ids_toinvoices.payment_status IN('Paid','Partial') AND ids_toinvoices.invoice_dealerid = dealers.id  ORDER BY invoice_id DESC ";
