...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "invoiceBody")) {
  ...
  $updateGoTo = "script_update_recurring_invoice.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysqli_select_db($idsconnection_mysqli, $database_idsconnection);
$query_queryInvoice =  "SELECT * FROM `idsids_idsdms`.`ids_toinvoices_recurring`, `idsids_idsdms`.`dealers` WHERE ids_toinvoices_recurring.invoice_dealerid = dealers.id AND ids_toinvoices_recurring.invoice_id = $colname_queryInvoice";
...
<title>Update | Recurring Invoice</title>
...
?>
			  ...
			  if(!$did) { 
			  	...
			  	$thisdid = $row_queryInvoice['invoice_dealerid'];
			  
			  echo "<a href='dealer-view-update.php?dealer=$thisdid'>";
      ...
      <div class="subblock">
        ...
        <table width="100%" border="0" cellspacing="3" cellpadding="3" class="gwlines">
                  <tr>
                    ...
                    <th><input name="invoice_number" type="text" value="<?php echo $row_queryInvoice['invoice_number']; ?>" />
                    <input name="invoice_sendtoclient" type="hidden" id="invoice_sendtoclient" value="Y" /> 
                    
                                    <input type="hidden" name="invoice_tokenid" class="text" id="invoice_tokenid" value="<?php echo $row_queryInvoice['invoice_tokenid']; ?>" />
                  ...
                  <tr>
                    ...
                    <th><input name="invoice_date"  id="datepicker" type="text" value="<?php echo $row_queryInvoice['invoice_date']; // $nowdate; ?>" /></th>
                  </tr>
                  <tr>
                    <th>Status</th>
				...
				<tr>
                    ...
                    <th><input name="invoice_latefee" type="text" id="invoice_latefee" value="<?php echo $row_queryInvoice['invoice_latefee']; ?>" size="5" /></th>
				</tr>
...
<?php include("invoice-line-items-update.php"); ?>
  ...
  <tr>
    <th rowspan="5" scope="row">
    	...
    	<textarea id="invoice_comments" name="invoice_comments" rows="20" cols="50"><?php echo $row_queryInvoice['invoice_comments']; ?></textarea>
  ...
  <tr>
    ...
    <td><input type="submit" name="submit2" id="submit2" value="Submit" />
      ...
      <input name="invoice_lastmodified" type="hidden" id="invoice_lastmodified" value="<?php echo $timevar; ?>" /></td>
              ...
              <p><a href="../convert-recurring-invoice.php?invoice_id=<?php echo $colname_queryInvoice; ?>&amp;id=<?php echo $ldid; ?>" onclick="tellInvoice()">Convert Into Real Invoice &raquo;</a></p>
            </div>
          </div>
        </div>
