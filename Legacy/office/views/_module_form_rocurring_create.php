<div class="row">
                                                                <div class="col-sm-12">
                                                                <h2>New Reoccuring Invoice <a id="dealer_create_invoice_name" href="#">Create New Automatic Invoicing</a></h2>

                                                                <h3>Create A Reoccuring Invoice<small>Create New Automatic Invoicing</small></h3>
                                                                <div id="load_create_new_invoice">
                                                                                <input name="recurring_invoice_dealerid" type="hidden" id="recurring_invoice_dealerid" value="<?php echo $system_dealerid; ?>">



                                                                                <input name="new_recurring_invoice_id" type="hidden" id="new_recurring_invoice_id"  value="<?php echo $system_dealerid; ?>">
                                                                    ...
                                                                    <div class="form-horizontal">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-sm-10">
                                                                                <input type="number" placeholder="Days To Pay Invoice" id="recurring_daysto_payinvoice" class="form-control" value="<?php echo $row_recurringInvoice['daysto_payinvoice']; ?>">
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-sm-10">
                                                                                        ...
                                                                                        <?php
                                                                                        $recurring_dealer_email_recipients = '';

                                                                                        $dealer_email_recipients = $row_recurringInvoice['dealer_email_recipients'];
                                                                                        $accts_payables_email = $row_recurringInvoice['accts_payables_email'];

                                                                                            if(!$dealer_email_recipients)
                                                                                            { $recurring_dealer_email_recipients .= $row_recurringInvoice['email'];
                                                                                            }else{
                                                                                                $recurring_dealer_email_recipients .=  $row_recurringInvoice['email'].", ".$row_recurringInvoice['accts_rcvbles_email'];
                                                                                            }

                                                                                            if(!$accts_payables_email){
                                                                                                // Do Nothing
                                                                                            }else{
                                                                                                $recurring_dealer_email_recipients .= ", ".$row_recurringInvoice['accts_payables_email'];
                                                                                                }
                                                                                            ?>

                                                                                    <input type="text" placeholder="Email Recipients"
                                                                                    id="recurring_dealer_email_recipients" class="form-control" value="<?php echo $recurring_dealer_email_recipients; ?>">
                                                                        ...
                                                                        <div class="hr-line-dashed"></div>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="col-sm-10">
                                                                                    <input type="number" placeholder="Sales Taxrate" id="recurring_sales_taxrate" class="form-control" value="0.00">
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="col-sm-10">
                                                                                    <input type="number" placeholder="Discount Value" id="recurring_discount_value" class="form-control" value="0.00">
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="col-sm-10">
                                                                                    <input type="number" readonly="readonly" disabled="disabled" placeholder="Invoice Subtotal" id="recurring_invoice_subtotal" class="form-control" value="0.00">
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="col-sm-10">
                                                                                    <input type="text" placeholder="Tax Shipping" id="recurring_tax_shipping" class="form-control" readonly="readonly" disabled="disabled" value="0.00">
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="col-sm-10">
                                                                                    <input type="text" placeholder="Invoice Taxtotal" id="recurring_invoice_taxtotal" readonly="readonly" disabled="disabled" class="form-control" value="0.00">
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="col-sm-10">
                                                                                    <input type="text" readonly="readonly" disabled="disabled" placeholder="Invoice Total" id="recurring_invoice_total" class="form-control" value="0.00">
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="col-sm-10">
                                                                                        <div class="input-group m-b">
                                                                                            <input type="text" placeholder="Invoice Amount Due" id="recurring_invoice_amount_due" readonly="readonly" disabled="disabled" class="form-control" value="0.00">
