<?php
//Name Full
$coappfulltitlename = $row_creditapp_id_did['co_applicant_titlename'];
$coappfullnamefml =  $row_creditapp_id_did['co_applicant_name'];
...
//Co App Socials
$coappsocial = $row_creditapp_id_did['co_applicant_ssn'];
$coappsocial2 = $row_creditapp_id_did['co_applicant_ssn4'];


//Names Seperated
$coapplname = $row_creditapp_id_did['co_applicant_lname'];
$coappfname = $row_creditapp_id_did['co_applicant_fname'];
$coappmname = $row_creditapp_id_did['co_applicant_lname'];

//Co Applicant Emails
$coappemail = $row_creditapp_id_did['co_applicant_email'];
$coappbusinessemail = $row_creditapp_id_did['co_applicant_email2'];

//Standard Definitions
$coappsuffix = $row_creditapp_id_did['co_applicant_suffixname'];
$coappdob = $row_creditapp_id_did['co_applicant_dob'];
$coappage = $row_creditapp_id_did['co_applicant_age'];
$coappaddrs = $row_creditapp_id_did['co_applicant_present_addr1'];
$coappaddrs2 = $row_creditapp_id_did['co_applicant_present_addr2'];
$coappaddrslyrs = $row_creditapp_id_did['co_applicant_present_addr_live_years'];
$coappaddrslmos = $row_creditapp_id_did['co_applicant_present_addr_live_months'];
$coappdriverlcno = $row_creditapp_id_did['co_applicant_driver_licenses_no'];
$coappdriverlcst = $row_creditapp_id_did['co_applicant_driver_licenses_state'];
$coappdriverlcstatus = $row_creditapp_id_did['co_applicant_driver_licenses_status'];
$coappcity = $row_creditapp_id_did['co_applicant_present_addr_city'];
$coappcounty = $row_creditapp_id_did['co_applicant_present_addr_county'];
$coappstate = $row_creditapp_id_did['co_applicant_present_addr_state'];
$coappzip = $row_creditapp_id_did['co_applicant_present_addr_zip'];
...
$coapphomephno = $row_creditapp_id_did['co_applicant_home_phone'];
$coappcellphno = $row_creditapp_id_did['co_applicant_cell_phone'];
...
$coappemployernm = $row_creditapp_id_did['co_applicant_employer_name'];
$coappemployeraddr = $row_creditapp_id_did['co_applicant_employer_addr'];
$coappemployeraddr2 = $row_creditapp_id_did['co_applicant_employer_addr2'];
$coappemployercity = $row_creditapp_id_did['co_applicant_employer_city'];
$coappemployerst = $row_creditapp_id_did['co_applicant_employer_state'];
$coappemployerzip = $row_creditapp_id_did['co_applicant_employer_zip'];
$coappemployerphno = $row_creditapp_id_did['co_applicant_employer_phone'];
$coappemployerext = $row_creditapp_id_did['co_applicant_employer_phone_ext'];
$coappemployerdept = $row_creditapp_id_did['co_applicant_employer_department'];
$coappemployersupervisr = $row_creditapp_id_did['co_applicant_employer_supervisor_name'];
$coappemployersupervisrphn = $row_creditapp_id_did['co_applicant_employer_supervisor_phone'];
$coappemployerhrshft = $row_creditapp_id_did['co_applicant_employer_hours'];
$coappemployerwkyrs = $row_creditapp_id_did['co_applicant_employer_work_years'];
$coappemployerwkmos = $row_creditapp_id_did['co_applicant_employer_work_months'];
...
//Co Applicant Income
$coappgrossincome = $row_creditapp_id_did['co_applicant_income_bringhome'];
$coappgrossincomefreq = $row_creditapp_id_did['co_applicant_payday_frequency'];
