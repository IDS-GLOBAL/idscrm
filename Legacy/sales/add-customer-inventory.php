...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "updateCustleadsbyid")) {
  $updateSQL =  "UPDATE cust_leads SET cust_nickname=%s, cust_fname=%s, cust_mname=%s, cust_lname=%s, cust_email=%s, cust_dealer_id=%s, cust_vehicle_id=%s, cust_salesperson_id=%s, cust_date_td=%s, cust_hour_td=%s, cust_min_td=%s, cust_lead_token=%s WHERE cust_leadid=%s",
