...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "updateCustleadsbyid")) {
  $updateSQL =  sprintf("UPDATE cust_leads SET cust_nickname=%s, cust_fname=%s, cust_mname=%s, cust_lname=%s, cust_email=%s, cust_dealer_id=%s, cust_vehicle_id=%s, cust_salesperson_id=%s, cust_date_td=%s, cust_hour_td=%s, cust_min_td=%s, cust_lead_token=%s WHERE cust_leadid=%s",
        ...
        <div class="gadget_border">
          ...
          <div class="gadget_content">
            ...
            <p>
              ...
              <p>Note: You can send this customer a email with link, directions, mobile friendly view, and also allow them to select inventory you should be able to send. </p>
              <p>Send A Work Up To This Customer By Email, <br />
Follow Up Within So Many Hours, <br />
Track This Customer For 72 Hours... </p>
...
<table width="600" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    <td colspan="2"><input name="cust_nickname" type="text" id="cust_nickname" value="<?php echo $clnickname; ?>" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    			...
    			<table width="500">
                  <tr>
                    <td><label>
                      ...
                      Invite This Customer To Close</label></td>
      ...
      <div class="gadget jsi_gv">
        ...
        <div class="gadget_border">
          ...
          <div class="gadget_content">
            ...
            <ol>
              <li>
                <label for="name"><strong>Year</strong> (Small input form example)</label>
