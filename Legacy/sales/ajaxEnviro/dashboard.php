    ...
    <div class="block_gr vertsortable">
      ...
      <div class="gadget jsi_gv">
        <div class="gadget_border">
          ...
          <div class="gadget_content">
            ...
            <li><a href="#"><img src="../images/icon23.gif" alt="picture" width="48" height="48" /></a><br /><a href="#">Inventory</a></li>
            
              <li><a href="#"><img src="../images/icon21.gif" alt="picture" width="48" height="48" /></a><br />
              <a href="#">My Task(s)</a></li>
              <li><a href="#"><img src="../images/icon22.gif" alt="picture" width="48" height="48" /></a><br /><a href="../myacct.php">My Acct.</a></li>
              
              <li><a href="../full-credit-app.php"><img src="../images/icon24.gif" alt="picture" width="48" height="48" /></a><br /><a href="../sales-creditapplication.php">Credit Application</a></li>
      ...
      <div class="horizsortable">
        ...
        <div class="gadget jsi_gh">
          ...
          <ul class="whitesquare"><li><a href="../coming-soon.php">Lorem ipsum dolor sit amet</a></li></ul>
        </div>
        ...
        <div class="gadget jsi_gh">
          <div class="gadget_border">
            ...
            <div class="gadget_content"> <a href="../full-credit-app.php"><img src="../images/icon33.gif" alt="picture" width="48" height="48" class="leftimg" /></a>
              ...
              <p><a href="../coming-soon.php">Update Or Edit A Previous Auto Credit Application From Your Existing Customers List.</a></p>
        ...
        <div class="gadget jsi_gh">
          <div class="gadget_border">
            ...
            <div class="gadget_content">
              ...
              <div class="miniblock">
              <h4>View / Edit Email Letters</h4>
              <p><a href="../coming-soon.php">View Or Edit Letters In Your Account To Send To Customers.</a></p></div>
              <a href="#"><img src="../images/icon36.gif" alt="picture" width="48" height="48" class="leftimg" /></a>
              <div class="miniblock">
                <h4>View Sent Letters</h4>
                <p><a href="../coming-soon.php">See email communications sent to your customers and when they were sent..</a></p></div>
              <div class="clr"></div>
            </div>
          </div>
          <ul class="whitesquare"><li><a href="../coming-soon.php">Lorem ipsum dolor sit amet</a></li></ul>
      ...
      <div class="gadget jsi_gv">
        <div class="gadget_border">
          <h3>Customer Leads <span>This is A Quick Snapshot Of Your Lastest Leadst</span></h3>
          <div class="gadget_content">
      ...
      <div class="gadget jsi_gv">
        <div class="gadget_border">
          ...
          <div class="gadget_content">
            ...
            <div class="clr"></div>
            <p><a href="../coming-soon.php" class="bg_grey">+ Add Event</a> &nbsp; <a href="#" class="bg_grey">List Events</a></p>
          </div>
        </div>
      </div>
