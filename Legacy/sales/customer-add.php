...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "customerUpdate")) {
  ...
  $insertGoTo = "script-customer-add.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div class="gadget jsi_gv">
        <div class="gadget_border">
          ...
          <div class="gadget_content">
            <form name="customerUpdate" action="<?php echo $editFormAction; ?>" method="POST" id="customerUpdate" class="form_example">
            <ol>
...
<input name="customer_frmsource" type="hidden" id="customer_frmsource" value="Manually" />
...
<input name="customer_hour_td" type="hidden" value="" />
...
<input name="customer_status" type="hidden" id="customer_status" value="Pending" />
                ...
                <select id="customer_sales_person_id" name="customer_sales_person_id">
                  <option value="" <?php if (!(strcmp("", $row_userSets['salesperson_id']))) {echo "selected=\"selected\"";} ?>>Select SalesPerson</option>
                  <?php
do {  
?>
<option value="<?php echo $row_salespersons['salesperson_id']?>"<?php if (!(strcmp($row_salespersons['salesperson_id'], $row_userSets['salesperson_id']))) {echo "selected=\"selected\"";} ?>><?php echo $row_salespersons['salesperson_firstname']?> <?php echo $row_sales_person['salesperson_lastname']?></option>
                  <?php
...
do {  
?>
                  <option value="<?php echo $row_sales_person['salesperson_id']?>"><?php echo $row_sales_person['salesperson_firstname']?> <?php echo $row_sales_person['salesperson_lastname']?></option>
                  <?php
...
do {  
?>
								            <option value="<?php echo $row_Managers['manager_id']?>"><?php echo $row_Managers['manager_firstname']?> </option>
								            <?php
...
<select name="customer_title" class="ui-state-default" id="customer_title">
                ...
                <input id="customer_fname" name="customer_fname" class="text small" />
                <input id="customer_mname" name="customer_mname" class="text tiny" />
                <input id="customer_lname" name="customer_lname" class="text medium" />
              ...
              <li>
                ...
                <input name="customer_dob" id="datepicker2" class="text small" />
                <input id="customer_ssn" name="customer_ssn" class="text small" />
			  ...
			  <li>
                ...
                <input id="customer_email" name="customer_email" class="text large" />
...
<li>
                ...
                <input id="customer_home_addr1" name="customer_home_addr1" class="text medium" />
                <input id="customer_dlno" name="customer_dlno" class="text small" />
...
?>
                ...
                <input name="customer_dlexpdate" id="datepicker" class="text small" />
                <div class="clr"></div>
              ...
              <li>
                ...
                <input id="customer_home_addr2" name="customer_home_addr2" class="text medi" />

<label class="floatright">                                   
Live Years:                <select name="customer_home_live_years">
...
?>
              ...
              <li>
                ...
                <input id="customer_home_city" name="customer_home_city" class="text small" />
...
?>
                ...
                <input id="customer_home_zip" name="customer_home_zip" class="text small" />
                <input id="customer_home_county" name="customer_home_county" class="text small" />                
                <div class="clr"></div>
              ...
              <li>
                ...
                <input id="customer_phoneno" name="customer_phoneno" class="text small" />
                <input id="customer_cellphone" name="customer_cellphone" class="text small" />
                <input id="customer_employer_phone" name="customer_employer_phone" class="text small" />
                <input id="customer_gross_income" name="customer_gross_income" class="text small" />                
                <select id="customer_income_frequency" name="customer_income_frequency">
                  <option value="">Select PaySchedule</option>
                  <?php
do {  
?>
                  <option value="<?php echo $row_paydayType['income_option']?>"><?php echo $row_paydayType['income_option']?></option>
                  <?php
...
?>
              ...
              <li>
                ...
                <input id="customer_employer_name" name="customer_employer_name" class="text small" />
                <input id="customer_employer_addr1" name="customer_employer_addr1" class="text small" />
                <input id="customer_employer_addr2" name="customer_employer_addr2" class="text small" />
                <input name="customer_employer_hiredate" id="datepicker5" class="text small" />                
                <div class="clr"></div>
              ...
              <li>
                ...
                <input id="customer_employer_city" name="customer_employer_city" class="text small" />
...
?>
                ...
                <input id="customer_employer_zip" name="customer_employer_zip" class="text small" />                
                <select id="customer_employer_years" name="customer_employer_years">
                  <option selected="selected" value="">Work Years</option>
                  <?php
do {  
?>
...
?>
                ...
                <select id="customer_employer_months" name="customer_employer_months">
                  <option selected="selected" value="">Work Months</option>
                  <?php
do {  
?>
...
?>
              ...
              <li>
                ...
                <input id="multiply1" name="multiply1" type="button" value="Save & Process" />
                ...
                <input id="titleconjucation" name="titleconjucation" class="text small" placeholder="AND/OR" />
                <input id="customer2_relationship" name="customer2_relationship" class="text small" placeholder="EX. Spouse" />                
                <div class="clr"></div>
...
<select name="customer2_title" class="ui-state-default" id="customer2_title">
                ...
                <input id="customer2_fname" name="customer2_fname" class="text small" />
                <input id="customer2_mname" name="customer2_mname" class="text tiny" />
                <input id="customer2_lname" name="customer2_lname" class="text medium" />
              ...
              <li>
                ...
                <input name="customer2_dob" id="datepicker4" class="text small" />
                <input id="customer2_ssn" name="customer2_ssn" class="text small" />
			  ...
			  <li>
                ...
                <input id="customer2_email" name="customer2_email" class="text large" />
...
<li>
                <label for="multiply"><strong>Address 1</strong></label>
                <input id="customer2_home_addr1" name="customer2_home_addr1" class="text medium" />
                <input id="customer2_dlno" name="customer2_dlno" class="text small" />
...
?>
                ...
                <input name="customer2_dlexpdate" id="datepicker3" class="text small" />
                <div class="clr"></div>
                <label for="customer2_fname" class="smallmediumwider">(Ex. 1122 Street Name )</label>                
                <label for="customer2_mname" class="small">DL No</label>                
                <label for="customer2_lname" class="smallselect">DL State</label>
                <label for="customer2_lname" class="small">Exp. Date</label>
                <div class="clr"></div>
              </li>
              ...
              <li>
                ...
                <input id="customer2_home_addr2" name="customer2_home_addr2" class="text medi" />
...
?>
              ...
              <li>
                <label for="multiply"><strong>City State &amp; Zip:</strong> (small input form example)</label>
                <input id="customer2_home_city" name="customer2_home_city" class="text small" />
...
?>
                ...
                <input id="customer2_home_zip" name="customer2_home_zip" class="text small" />
                <input id="customer2_home_county" name="customer2_home_county" class="text small" />                
                <div class="clr"></div>
              ...
              <li>
                <label for="multiply"><strong>Phone &amp; Income Verfication Info</strong> </label>
                <input id="customer2_phoneno" name="customer2_phoneno" class="text small" />
                <input id="customer2_cellphone" name="customer2_cellphone" class="text small" />
                <input id="customer2_employer_phone" name="customer2_employer_phone" class="text small" />
                <input id="customer2_gross_income" name="customer2_gross_income" class="text small" />                
...
?>
              ...
              <li>
                <label for="multiply"><strong>Employer Name &amp; Verfication Section</strong></label>
                <input id="customer2_employer_name" name="customer2_employer_name" class="text small" />
                <input id="customer2_employer_addr1" name="customer2_employer_addr1" class="text small" />
                <input id="customer2_employer_addr2" name="customer2_employer_addr2" class="text small" />
                <input name="customer2_employer_hiredate" id="datepicker6" class="text small" />                
                <div class="clr"></div>
              ...
              <li>
                ...
                <input id="customer2_employer_city" name="customer2_employer_city" class="text small" />
...
?>
                ...
                <input id="customer2_employer_zip" name="customer2_employer_zip" class="text small" />                
...
?>
            ...
            <input type="hidden" name="MM_insert" value="customerUpdate">
            </form>
          ...
          <div class="gadget_content">
            ...
            <ol>
             <li>
              ...
              <input name="appointmentDate" class="text" id="datepicker7" onChange="appointmentT()" />
              <div class="clr"></div>
            </li>
            <li>
            <div>
