...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "updateCustleadsbyid")) {
  $updateSQL =  sprintf("UPDATE cust_leads SET cust_nickname=%s, cust_fname=%s, cust_mname=%s, cust_lname=%s, cust_email=%s, cust_lead_temperature=%s, cust_phoneno=%s, cust_phonetype=%s, cust_dealer_id=%s, cust_vehicle_id=%s, cust_salesperson_id=%s, cust_date_td=%s, cust_hour_td=%s, cust_min_td=%s, cust_lead_token=%s WHERE cust_leadid=%s",
  ...
  <tr>
    <td colspan="3">
     ...
     <!-- gadget usertable -->
        ...
        <div class="gadget jsi_gv">
        <div class="gadget_border">
          <h3>Choose From Your Inventory<span> To Send An Email To This Customer Above.</span></h3>
          <div class="gadget_content">
              ...
              <tr>
                ...
                <?php do { ?>
                                <tr>
                                  ...
                                  <td><a href="email-vehicle.php?lead=<?php echo $cid; ?>&vid=<?php echo $row_salespersoninventory['vid']; ?>&sid=<?php echo $sid ?>"><img src="images/pimpa_tabs.gif" alt="picture" width="16" height="16" class="tabpimpa" /></a></td>
                                </tr>
