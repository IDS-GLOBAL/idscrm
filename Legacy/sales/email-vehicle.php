              ...
              <tr>
                ...
                <?php do { ?>
                                <tr>
                                  ...
                                  <td><a href="email-vehicle.php?vid=<?php echo $row_salespersoninventory['vid']; ?>&sid=<?php echo $sid ?>"><img src="images/pimpa_tabs.gif" alt="picture" width="16" height="16" class="tabpimpa" /></a></td>
                                </tr>
