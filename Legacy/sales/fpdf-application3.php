...
$pdf->Cell(40,10,'Credit Application: Applicant', 0,1,'L');
...
$pdf->Cell(1,-10,'Last Name:                                       First Name:                                  Initial:                             Suffix:                    Date Of Birth:                 Soc. Sec. # :', 0,0,'L');


$pdf->SetFont('Courier','',10);
$pdf->Cell(40,-4,$applname, 0,0,'L');
...
$pdf->SetFont('Courier','',10);
$pdf->Cell(50,-4,$appemployernm, 0,0,'L');
...
$pdf->Cell(1,-10,'Previous Employer Name:                           Previous Occupation/Title:                Prev. Phone Number:                               Time On Previous Job | Years/Months:', 0,0,'L');


$pdf->SetFont('Courier','',10);
$pdf->Cell(50,-4,$appemployer2nm, 0,0,'L');
...
$pdf->Cell(40,4,'The undersigned herby authorizes selling dealer to initiate a credit investigation based upon the following information, which information has been voluntarily', 0 ,2 ,'L');
...
$pdf->Cell(40,4,'marital status, age (provided that the applicant has the capacity to contrct); because all or part of the applicants income derives from any public assistance program; or',0 ,2 ,'L');
$pdf->Cell(40,4,'because the applicant has in good faith exercised any right under the Consumer Credit Protection Act.  The federal agency that asministers compliance with this law',0 ,2 ,'L');
$pdf->Cell(40,4,'concering this creditor is the Federal Trade Commission, Equal Credit Oppotunity, Washington, D.C. 20580.',0 ,2 ,'L');
$pdf->Cell(40,3,' ', 0,1,'L');
