...
var $tkey2;					//My Hack For Dynamic Header
/*******************************************************************************
*                                                                              *
*                               Public methods                                 *
*                                                                              *
...
function SetTkey2($tkey2, $isUTF8=false)
{
	// Token of this document
	if($isUTF8)
		$tkey2 = $this->_UTF8toUTF16($tkey2);
	$this->tkey2 = $tkey2;
}
...
function _putinfo()
{
	...
	if(!empty($this->tkey2))
		$this->_out('/Tkey2 '.$this->_textstring($this->tkey2));
