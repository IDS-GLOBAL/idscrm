...
<table cellpadding="10" cellspacing="5" border="0" id="dataTable">
    ...
    <?php
				...
				$vehicle = "$vyear $vmake $vtrim";
				$cvid= $row_salespersoninventory['vid'];
    ?>
    <tr>
      <td>
      <a href="<?php echo $row_salespersoninventory['vid']; ?>"><?php echo showphoto($cvid); ?></a>
      </td>
      <td><?php echo $row_salespersoninventory['vstockno']; ?></td>
      <td>
	  <?php echo $vehicle; ?><br>
