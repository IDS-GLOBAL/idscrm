...
/* show or hide gadget */
  ...
  $('a[rel="hide_block"]').click(function(){
	if ($(this).parent('div').parent('div').children('div.gadget_content').css('height')=='auto') $(this).css('background-image','url(images/gadget_dropup.gif)');
	else $(this).css('background-image','url(images/gadget_dropdown.gif)');
