...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "ovrphngoal")) {
  $insertSQL =  sprintf("INSERT INTO cust_leads (cust_nickname, cust_email, cust_phoneno, cust_dealer_id, cust_salesperson_id, cust_date_td) VALUES (%s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "customer-inventory.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<!-- MAIN CONTENT -->
	...
	<?php include('custom_pages/mywebsite_page.php') ?>
<!-- FOOTER -->
