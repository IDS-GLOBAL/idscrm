...
mysqli_select_db($idsconnection_mysqli, $database_idsconnection);
$query_Vyears = "SELECT * FROM car_years ORDER BY car_year DESC";
$Vyears = mysqli_query($idsconnection_mysqli, $query_Vyears);
$row_Vyears = mysqli_fetch_assoc($Vyears);
$totalRows_Vyears = mysqli_num_rows($Vyears);

mysqli_select_db($idsconnection_mysqli, $database_idsconnection);
$query_Vmakes = "SELECT * FROM car_make ORDER BY make_id ASC";
...
mysqli_select_db($idsconnection_mysqli, $database_idsconnection);
$query_Vmodels = "SELECT * FROM car_model ORDER BY make ASC";
...
<body>
<form action="" method="post" name="MakeModelAdd" id="MakeModelAdd">
  <p>&nbsp;</p>
  <p>
    <label>Year
  ...
  <p>
    <label>Model
      <select name="vmodelid" id="vmodelid">
      </select>
    </label>
