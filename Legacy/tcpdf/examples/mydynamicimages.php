...
require_once('tcpdf_include.idscrm.php');
...
$pdf->SetSubject('TCPDF CLASS');
$pdf->SetKeywords('TCPDF, PDF, example, test, guide');

// set default header data
$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, PDF_HEADER_TITLE." $company", PDF_HEADER_STRING);
...
$html = "<div style='text-align:center'>The words $photos | $photo_openurl &#8220;<span dir='rtl'>&#1502;&#1494;&#1500; [mazel] &#1496;&#1493;&#1489; [tov]</span>&#8221; mean &#8220;Congratulations!&#8221;".''.$whatever.''.' </div>';
...
$whatever = '<img src="images/logo_example.png" alt="test alt attribute" width="100" height="100" border="0" /> <img src="images/logo_example.png" alt="test alt attribute" width="100" height="100" border="0" /> ';
// output some RTL HTML content
$html = "<div style='text-align:center'>The words &#8220;<span dir='rtl'>&#1502;&#1494;&#1500; [mazel] &#1496;&#1493;&#1489; [tov]</span>&#8221; mean &#8220;Congratulations!&#8221;".''.$whatever.''.' </div>';
$pdf->writeHTML($html, true, false, true, false, '');
