<?php
$bigphoto2 = $row_qryURLvehicle['vthubmnail_file'];
$climgsrc2 = "<img border='8' src='http://craigslist.autocitymag.com/$did/$vid/$bigphoto2' width='350' height='263' style='border: 3 solid #000000; '> ";
?>
...
</font></td><td width="33%" valign="top"><?php echo $climgsrc2; ?></a></td></tr></table></td></tr>
...
?>
<?php
$vtphoto2 = $row_showVehiclePhotos2['photo_thumb_fname'];
$clvtimgsrc2 = "<img border='15' src='http://craigslist.autocitymag.com/$did/$vid/thumbs/$vtphoto2' width='120' height='90' hspace='3' vspace='10' />";
?>
<a href="#">
<?php echo $clvtimgsrc2; ?>
</a>
<?php 
////////////////////////////////////////////Ends The Photo Loop
} while ($row_showVehiclePhotos2 = mysqli_fetch_assoc($showVehiclePhotos2)); 
?><br><br>
