 ...
 * This example bulk posting client script is written in perl5 and requires the LWP perl module. 
 * It processes commandline options, reads an RSS file from disk, then submits it to craigslist for either verification or posting. 
 * It returns the reply RSS to STDOUT unless -o option is specified.
 */
