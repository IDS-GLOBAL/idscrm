...
<br/>
creating this for <a href="IDSCRM.com">IDSCRM.com</a>
<br/>
...
$your_domain = "http://idscrm.com/test/Text-ToSpeech/php-TTS/files/";
...
<form class="form" action="<?=$_SERVER['PHP_SELF']?>" method="get">
	<label>Heckle</label>
	<input type="text" class="text" name="heckle"  size="100" value="<?php echo $string; ?>"/>
	<input type="submit" class="submit" value="Play Video"/>
</form>
...
<div class="widget-wrap"><div class="widget widget_text">			<div class="textwidget"><script type="text/javascript">
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-26722542-1']);
  _gaq.push(['_setDomainName', 'idscrm.com']);
