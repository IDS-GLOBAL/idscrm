...
<html>
	...
	<body>
        <div id="container">
            <h1>jquery.datePicker example: simple datePicker today selected</h1>
            ...
            <p>
				...
				input fields. Today's date is set as the default by putting it into the input field (see <a href="datePickerDefaultToday2.html">here</a>
				for an example without putting the value in the input field).
            </p>
